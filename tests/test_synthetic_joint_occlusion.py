"""CPU smoke tests for synthetic joint occlusion augmentation."""
...
from motionflow_mv.data.prototypes.synthetic_joint_occlusion import (
...
def test_occlude_named_groups():
    ...
    V, J, C = 4, 17, 3
    x = torch.ones(2, V, J, C)
    x[..., -1] = 1.0  # confidence = 1.0
...
if __name__ == "__main__":
    ...
    print("All synthetic joint occlusion smoke tests passed.")
