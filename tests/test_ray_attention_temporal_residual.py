"""Lightweight sanity tests for the temporal residual refinement model."""
...
def test_temporal_residual_forward_shape_and_grad():
    B, T, V, J = 2, 5, 4, 17
...
def test_single_frame_residual_compatibility():
    B, V, J = 2, 4, 17
    cameras = _make_cameras(V)
...
if __name__ == "__main__":
    test_temporal_residual_forward_shape_and_grad()
    test_single_frame_residual_compatibility()
    print("temporal residual refinement tests passed")
