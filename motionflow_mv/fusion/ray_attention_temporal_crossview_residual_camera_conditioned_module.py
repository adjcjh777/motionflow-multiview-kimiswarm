"""FusionModule wrapper around the camera-parameter-conditioned anchor model.

Makes ``RayAttentionFusionModelTemporalCrossviewResidualCameraConditioned``
...
from .ray_attention_temporal_crossview_residual_camera_conditioned_model import (
    RayAttentionFusionModelTemporalCrossviewResidualCameraConditioned,
)


class RayAttentionTemporalCrossviewResidualCameraConditionedFusionModule(FusionModule):
    """Cross-view temporal ray-attention fusion with camera-conditioned heads.
    ...
    camera_condition_dim:
        Dimension of the injected camera-condition vector in the weight head.
    residual_condition_dim:
        Dimension of the rig-condition vector in the residual refiner.
    checkpoint_path:
    ...
    def __init__(
        ...
        self.model = RayAttentionFusionModelTemporalCrossviewResidualCameraConditioned(
            j=j,
            d=d,
            n_views=n_views,
            ...
            residual_condition_dim=residual_condition_dim,
        )
...
def register_ray_attention_temporal_crossview_residual_camera_conditioned_fusion_module() -> None:
    """Register the camera-conditioned cross-view residual fusion module."""
    from .fusion_module import FUSION_REGISTRY

    FUSION_REGISTRY.register(RayAttentionTemporalCrossviewResidualCameraConditionedFusionModule())
