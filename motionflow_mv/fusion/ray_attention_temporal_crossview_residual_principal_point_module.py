"""FusionModule wrapper around the best cross-view temporal residual + PP model.

This makes ``RayAttentionFusionModelTemporalCrossviewResidualPrincipalPoint``
...
class RayAttentionTemporalCrossviewResidualPrincipalPointFusionModule(FusionModule):
    """Cross-view temporal ray-attention fusion with principal-point correction.
    ...
    name = "ray_attention_temporal_crossview_residual_principal_point"
    ...
    def __init__(
        ...
        self.model = RayAttentionFusionModelTemporalCrossviewResidualPrincipalPoint(
            j=j,
            d=d,
            n_views=n_views,
...
def register_ray_attention_temporal_crossview_residual_principal_point_fusion_module() -> None:
    """Register the cross-view residual + PP fusion module."""
    from .fusion_module import FUSION_REGISTRY

    FUSION_REGISTRY.register(RayAttentionTemporalCrossviewResidualPrincipalPointFusionModule())
