"""FusionModule wrapper around the cross-view temporal residual + principal-point
+ camera-centric coordinate transform model.

This makes ``RayAttentionFusionModelTemporalCrossviewResidualPrincipalPointCameraCentric``
...
from .ray_attention_temporal_crossview_residual_principal_point_camera_centric_model import (
    RayAttentionFusionModelTemporalCrossviewResidualPrincipalPointCameraCentric,
)


class RayAttentionTemporalCrossviewResidualPrincipalPointCameraCentricFusionModule(FusionModule):
    """Cross-view temporal ray-attention fusion with principal-point and
camera-centric coordinate correction.
    ...
    name = "ray_attention_temporal_crossview_residual_principal_point_camera_centric"
    ...
    def __init__(
        ...
        self.model = RayAttentionFusionModelTemporalCrossviewResidualPrincipalPointCameraCentric(
            j=j,
            d=d,
            n_views=n_views,
...
def register_ray_attention_temporal_crossview_residual_principal_point_camera_centric_fusion_module() -> None:
    """Register the cross-view residual + PP + camera-centric fusion module."""
    from .fusion_module import FUSION_REGISTRY

    FUSION_REGISTRY.register(RayAttentionTemporalCrossviewResidualPrincipalPointCameraCentricFusionModule())
