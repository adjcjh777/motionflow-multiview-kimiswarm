"""Full trainer for the Gaussian-splatting pose regularizer (Tier-1 iter15 proposal).

Runs a full 20-epoch run on MPI-INF-3DHP with the same hyperparameters as the
PP robust re-train, plus the Gaussian-splatting auxiliary loss.
"""
...
def main():
    ...
    cmd = [
        ...
        "--output", "outputs/splat_pp_full_mpiinf3dhp.pth",
    ]
