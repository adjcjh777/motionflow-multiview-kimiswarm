"""Smoke trainer for the reprojection-consistency loss (Tier-1 iter14 proposal).

This is a thin wrapper around ``train_ray_attention_temporal_crossview_residual_principal_point_mpiinf3dhp.py``
that runs a 5-epoch smoke on a small MPI-INF-3DHP split with robust
reprojection losses applied to both the raw and refined 3-D poses.
"""
