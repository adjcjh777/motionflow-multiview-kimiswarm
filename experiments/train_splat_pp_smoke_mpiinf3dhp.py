"""Smoke trainer for the Gaussian-splatting pose regularizer (Tier-1 iter15 proposal).

This is a thin wrapper around ``train_ray_attention_temporal_crossview_residual_principal_point_mpiinf3dhp.py``
that runs a 5-epoch smoke on a small MPI-INF-3DHP split with the splat model and
an auxiliary Gaussian-splatting reprojection NLL loss.
"""
