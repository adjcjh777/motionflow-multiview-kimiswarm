"""Train the factorised (T x V x J) spatio-temporal PP model on MPI-INF-3DHP.

This script mirrors the principal-point training script but swaps the backbone for
...
def main():
    parser = argparse.ArgumentParser(description="Train factorised (T x V x J) spatio-temporal PP model on MPI-INF-3DHP")
    ...
    parser.add_argument("--n_view_layers", type=int, default=1)
    ...
    parser.add_argument("--output", type=str, default="outputs/spatiotemporal_principal_point_mpiinf3dhp.pth")
    ...
    print(f"n_views={n_views}, j={j}, clip_len={args.clip_len}, d={args.d}, "
          f"T/V/J layers={args.n_temporal_layers}/{args.n_view_layers}/{args.n_joint_layers}, "
