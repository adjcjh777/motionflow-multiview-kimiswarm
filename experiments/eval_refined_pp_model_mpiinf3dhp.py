"""Eval for the refined two-stage PP cross-view model."""
...
from motionflow_mv.fusion.ray_attention_temporal_crossview_residual_principal_point_refined_model import RayAttentionFusionModelTemporalCrossviewResidualPrincipalPointRefined
...
def build_model(args, n_views, j):
    return RayAttentionFusionModelTemporalCrossviewResidualPrincipalPointRefined(
        j=j,
        d=args.d,
        n_views=n_views,
...
def main():
    ...
    parser.add_argument("--out_json", type=str, default="outputs/refined_pp_eval.json")
