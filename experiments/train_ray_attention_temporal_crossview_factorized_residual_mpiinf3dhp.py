"""Train RayAttentionFusionModelTemporalCrossviewFactorizedResidual on MPI-INF-3DHP."""
...
from motionflow_mv.fusion.ray_attention_temporal_crossview_factorized_residual_model import (
...
def main():
    ...
    parser.add_argument("--output", type=str, default="outputs/ray_attention_temporal_crossview_factorized_residual_mpiinf3dhp.pth")
    ...
    print(f"n_views={n_views}, j={j}, clip_len={args.clip_len}, d={args.d}, n_view_layers={args.n_view_layers}, n_temporal_layers={args.n_temporal_layers}, residual_hidden={args.residual_hidden}")

    model = RayAttentionFusionModelTemporalCrossviewFactorizedResidual(
        j=j, d=args.d, n_views=n_views, n_view_layers=args.n_view_layers,
        n_temporal_layers=args.n_temporal_layers, residual_hidden=args.residual_hidden,
    ).to(device)
