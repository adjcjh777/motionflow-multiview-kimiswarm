"""Train RayAttentionFusionModelTemporalCrossviewUncertaintyResidualLearnedTriV1 on MPI-INF-3DHP clips.

Usage
-----
    conda run -n mf python experiments/train_ray_attention_temporal_crossview_uncertainty_residual_learned_tri_v1_mpiinf3dhp.py \
        --train data/webbridge/mpi_inf_3dhp/s_01_seq_01_v14_multiview_m.npz \
               data/webbridge/mpi_inf_3dhp/s_01_seq_02_v14_multiview_m.npz \
        --val data/webbridge/mpi_inf_3dhp/s_02_seq_01_v14_multiview_m.npz \
        --clip_len 13 --epochs 30 --reproj_weight 0.01 --uncertainty_weight 0.1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train advanced multi-view fusion model v1 on MPI-INF-3DHP")
