"""Comprehensive evaluation of RayAttentionFusionModelTemporalResidual.

Reports MPJPE, PA-MPJPE, PCK@50/100/150mm, and AUC on cross-subject
MPI-INF-3DHP clips.  Extends the temporal eval script to the residual
refinement model.
...
-------
    conda run -n mf python experiments/eval_ray_attention_temporal_residual_v3.py \
        ...
        --clip_len 13 --batch_size 8 --out outputs/eval_residual_v3_s2_seq1.json
"""
...
from motionflow_mv.fusion.ray_attention_temporal_residual_v3_model import (
    RayAttentionFusionModelTemporalResidualUncertainty,
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate temporal ray-attention fusion with residual refinement on MPI-INF-3DHP"
    )
