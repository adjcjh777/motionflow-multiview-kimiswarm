"""Evaluate a trained RayAttentionFusionModelTemporalResidual on MPI-INF-3DHP clips.
...
-----
    conda run -n mf python experiments/eval_ray_attention_temporal_residual_mpiinf3dhp.py \
        ...
        --clip_len 13 --d 64 --n_temporal_layers 2 --batch_size 8
"""
...
def main():
    ...
    parser.add_argument("--gt_scale", type=float, default=1.0, help="Scale ground truth joints (e.g. 0.001 for H36M mm->m)")
    parser.add_argument("--camera_scale", type=float, default=1.0, help="Scale camera translation (e.g. 0.001 for H36M mm->m)")
    ...
    print(f"TemporalResidual MPJPE: {mpjpe:.4f}m ({mpjpe*1000:.2f}mm)")
