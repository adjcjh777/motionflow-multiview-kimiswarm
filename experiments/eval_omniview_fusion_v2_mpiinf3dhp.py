"""Evaluation script for OmniMultiViewFusionV2 on MPI-INF-3DHP S2/Seq1.

Evaluates clean MPJPE / PA-MPJPE, an optional calibration-robustness matrix
(rotation, translation, focal, principal-point perturbations), and an optional
variable-view MPJPE@k curve (k=2..14). Results are written to JSON and CSV.
...
-----
    ...
    python experiments/eval_omniview_fusion_v2_mpiinf3dhp.py --smoke
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate OmniMultiViewFusionV2 on MPI-INF-3DHP S2/Seq1",
    )
    # Inputs
    ...
    # Outputs
    parser.add_argument("--out_json", type=str, default="outputs/eval_omniview_fusion_v2_mpiinf3dhp.json", help="JSON output path")
    parser.add_argument("--out_csv", type=str, default="outputs/eval_omniview_fusion_v2_mpiinf3dhp.csv", help="CSV output path")
