"""Train OmniMultiViewFusionV2 on MPI-INF-3DHP.

This script is a self-contained trainer for ``OmniMultiViewFusionV2`` that uses
...
``experiments/train_bayesian_tri_v2_mpiinf3dhp.py`` and adds the Omni-specific
...
-----
    ...
    python experiments/train_omniview_fusion_v2_mpiinf3dhp.py --smoke

    # Full MPI-INF-3DHP run
    python experiments/train_omniview_fusion_v2_mpiinf3dhp.py \
...
# ---------------------------------------------------------------------------
# Data loading (same pattern as train_bayesian_tri_v2_mpiinf3dhp.py)
# ---------------------------------------------------------------------------
...
def parse_args() -> Namespace:
    parser = argparse.ArgumentParser(
        description="Train OmniMultiViewFusionV2 on MPI-INF-3DHP",
    )
    # Data
    ...
    # I/O
    parser.add_argument("--output", type=str, default="outputs/omniview_fusion_v2_mpiinf3dhp.pth", help="Checkpoint path")
