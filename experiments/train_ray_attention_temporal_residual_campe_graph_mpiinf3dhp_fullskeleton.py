...
using the real 28-joint skeleton and symmetry pairs.
"""
...
class TemporalClipDataset(torch.utils.data.Dataset):
    def __init__(self, npz_path: str, clip_len: int, stride: int = 1):
        ...
        self.num_clips = max(1, (self.total_frames - self.clip_len) // self.stride + 1)
...
def main():
    ...
    parser.add_argument("--output", type=str, default="outputs/ray_attention_temporal_residual_campe_graph_mpiinf3dhp_fullskeleton.pth")
