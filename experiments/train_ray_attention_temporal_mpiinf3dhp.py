"""Train RayAttentionFusionModelTemporal on MPI-INF-3DHP clips.
...
meters (the ``_m`` suffix variants).  It slides / samples fixed-length clips and
trains a temporal ray-attention fusion model.  The best checkpoint by validation
MPJPE is saved.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train temporal ray-attention fusion on MPI-INF-3DHP")
    ...
    parser.add_argument("--output", type=str, default="outputs/ray_attention_temporal_mpiinf3dhp.pth")
