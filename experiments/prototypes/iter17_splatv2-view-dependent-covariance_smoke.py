"""Iter-17 CPU smoke test for SplatV2 view-dependent covariance."""
...
def main():
    parser = argparse.ArgumentParser(description="Iter-17 SplatV2 smoke")
    parser.add_argument("--train", type=str, default="data/webbridge/mpi_inf_3dhp/s_01_seq_01_v14_multiview_m_smoke.npz")
    ...
    parser.add_argument("--output", type=str, default="outputs/iter17_splatv2_smoke.pth")
    ...
    print(f"n_views={n_views}, j={j}, clip_len={args.clip_len}, d={args.d}, n_st_layers={args.n_st_layers}, residual_hidden={args.residual_hidden}, params={n_params}")
