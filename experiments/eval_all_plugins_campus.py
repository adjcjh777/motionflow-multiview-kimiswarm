"""Evaluate all FusionModule plugins on Campus multi-view 2D keypoints.

Reports reprojection error (px) for each plugin because Campus 3D GT is not
available locally.

Usage:
    /d/anaconda3/envs/jz_py310/python.exe experiments/eval_all_plugins_campus.py \
        --data_root tmp/voxelpose-pytorch/data/CampusSeq1 --frame_start 0 --frame_end 1200
"""
...
def main():
    ...
    parser.add_argument("--data_root", type=str, default="tmp/voxelpose-pytorch/data/CampusSeq1")
    ...
    loader = VoxelPoseCampusLoader(args.data_root)
