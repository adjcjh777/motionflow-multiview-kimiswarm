"""Combined clean + calibration-robustness evaluation for the principal-point model.

Usage
-----
    python experiments/eval_principal_point_model_mpiinf3dhp.py \
        --checkpoint outputs/ray_attention_temporal_residual_principal_point_mpiinf3dhp.pth \
        --dataset data/webbridge/mpi_inf_3dhp/s_02_seq_01_v14_multiview_m.npz \
        --out_json outputs/principal_point_model_eval.json
"""
...
def build_model(args, n_views, j):
    return RayAttentionFusionModelTemporalResidualPrincipalPoint(
        j=j,
        d=args.d,
        n_views=n_views,
...
def main():
    ...
    parser.add_argument("--out_json", type=str, default="outputs/principal_point_model_eval.json")
