"""Train RayAttentionFusionModelTemporalResidual on H36M.

Uses the same trainer as the MPI script but with H36M WebBridge paths.
"""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="outputs/ray_attention_temporal_residual_h36m.pth")
