"""Train RayAttentionFusionModelTemporalResidualCamPEGraph on H36M."""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="outputs/ray_attention_temporal_residual_campe_graph_h36m.pth")
