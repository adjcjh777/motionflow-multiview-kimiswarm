#!/usr/bin/env bash
# Local RTX 4090 smoke test for v59 View-Count-Conditioned Sparse-View
# Reliability (VCC-SVR) on top of the v45/v46/v50/v51/v52 stack.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_v59_view_count_conditioning \
    --v59_vcc_hidden 32 \
    --v59_vcc_n_layers 2 \
    --v59_vcc_max_views 8 \
    --num_workers 0 \
    ...
    --output outputs/omniview_fusion_v59_vcc_uwt_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v59_vcc_uwt_smoke_local_4090.log 2>&1
