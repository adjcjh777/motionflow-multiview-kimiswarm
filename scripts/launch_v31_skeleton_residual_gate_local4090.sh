#!/usr/bin/env bash
# v31 smoke test: per-joint skeleton-residual gate on local RTX 4090.
# NOTE: requires the v31 per-joint gate patch in
#       motionflow_mv/fusion/skeleton_graph_residual_refiner.py and the
#       corresponding --use_skeleton_residual_gate_v31 flag in the training script.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_skeleton_residual_gate_v31 \
    ...
    --use_context_visibility true --use_rotation_correction true \
    ...
    --output outputs/omniview_fusion_v31_skeleton_residual_gate_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_skeleton_residual_gate_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_skeleton_residual_gate_smoke_local_4090.pid
wait $!
