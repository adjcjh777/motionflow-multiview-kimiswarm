#!/usr/bin/env bash
# v23 small: v18 deformable cross-view attention + v22 KAP, WITHOUT neural bundle adjustment.
# v21 neural BA regressed to 128.27 mm; this ablation tests whether KAP alone improves v18.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v23_kap_no_ba_small.pth \
    > outputs/omniview_fusion_v23_kap_no_ba_small.log 2>&1
