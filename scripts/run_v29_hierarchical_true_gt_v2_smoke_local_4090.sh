...
# Usage
# -----
#   bash scripts/run_v29_hierarchical_true_gt_v2_smoke_local_4090.sh
#
#   # Run on a specific GPU
#   CUDA_VISIBLE_DEVICES=1 bash scripts/run_v29_hierarchical_true_gt_v2_smoke_local_4090.sh
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/smoke_v29_true_gt_v2/v29_hierarchical_true_gt_v2_smoke_local_4090.pth \
    > outputs/smoke_v29_true_gt_v2/v29_hierarchical_true_gt_v2_smoke_local_4090.log 2>&1
