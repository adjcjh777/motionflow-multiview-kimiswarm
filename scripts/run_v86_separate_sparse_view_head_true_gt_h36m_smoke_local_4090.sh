#!/usr/bin/env bash
# Local RTX 4090 smoke for v86: dedicated separate sparse-view head for k<4.
#
...
# number of active views is less than 4.  The head pools active-view ray
# tokens, injects a view-count embedding, and predicts a residual around the
# initial DLT estimate.  It is identity-at-init, so the full-view path is
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v86_separate_sparse_view_head_true_gt_h36m_smoke_local_4090.pth \
    > outputs/v86_separate_sparse_view_head_true_gt_h36m_smoke_local_4090.log 2>&1
