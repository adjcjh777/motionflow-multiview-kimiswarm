#!/usr/bin/env bash
# A800-D medium run for v81 temporal-pose-attention on the NON-CIRCULAR H36M
...
#   CUDA_VISIBLE_DEVICES=6 bash scripts/run_v81_true_gt_h36m_medium_a800.sh
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v81_true_gt_h36m_medium_a800.pth \
    > outputs/ablations/v81_true_gt_h36m_medium_a800.log 2>&1
