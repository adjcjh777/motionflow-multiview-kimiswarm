#!/usr/bin/env bash
# v16 experiment: joint-level occlusion + structured noise augmentation on top of v13.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --temporal_loss_weight 0.03 --temporal_acceleration_weight 0.25 --clip_len 27 \
    --occlusion_augment_prob 0.5 \
    --occlusion_joint_rate 0.08 \
    --occlusion_multiview_rate 0.04 \
    --occlusion_temporal_prob 0.15 \
    --occlusion_per_joint_noise_std 1.5 \
    --occlusion_per_view_noise_std 0.5 \
    --occlusion_min_visible_joints 5 \
    --output outputs/omniview_fusion_v16_occlusion_noise_fullscale.pth \
    > outputs/omniview_fusion_v16_occlusion_noise_fullscale.log 2>&1
