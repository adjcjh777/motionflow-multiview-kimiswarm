#!/usr/bin/env bash
# v23 full-scale: v18 deformable cross-view attention + v22 KAP, WITHOUT neural bundle adjustment.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v23_kap_no_ba_fullscale.pth \
    > outputs/omniview_fusion_v23_kap_no_ba_fullscale.log 2>&1
