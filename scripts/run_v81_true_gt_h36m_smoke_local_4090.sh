#!/usr/bin/env bash
# Local RTX 4090 smoke for v81 on NON-CIRCULAR H36M true-GT standard protocol.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v81_true_gt_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v81_true_gt_h36m_smoke_local_4090.log 2>&1
