#!/usr/bin/env bash
# v23b small: v18 deformable cross-view attention + v22 KAP (kap_loss_weight=0.001), no neural BA.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v23b_kap001_no_ba_small.pth \
    > outputs/omniview_fusion_v23b_kap001_no_ba_small.log 2>&1
