#!/usr/bin/env bash
# Local RTX 4090 smoke test for v58 Simplified Domain-Conditional
# Physical-Space Calibration (SD-PSC) on top of the v45/v46/v50/v51/v52 stack.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v58_sdpsc_hidden 64 \
    --v58_sdpsc_n_layers 2 \
    --v58_sdpsc_num_domains 8 \
    --v58_sdpsc_use_floor \
    --v58_sdpsc_use_bone_scale \
    --v58_sdpsc_use_uwt_weights \
    --v58_sdpsc_identity_init \
    --v58_sdpsc_residual_gate_init -6.0 \
    --v58_sdpsc_loss_weight 0.1 \
    --v58_sdpsc_floor_weight 0.01 \
    --v58_sdpsc_bone_weight 0.1 \
    --v58_sdpsc_reproj_weight 0.1 \
    --v58_sdpsc_warmup_epochs 1 \
    --v58_sdpsc_min_visible_views 2 \
    --num_workers 0 \
    --d 64 \
    --residual_hidden 128 \
    --n_st_layers 2 \
    ...
    --output outputs/omniview_fusion_v58_simplified_domain_psc_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v58_simplified_domain_psc_smoke_local_4090.log 2>&1
