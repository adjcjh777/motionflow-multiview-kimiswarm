"""Evaluate a v81 OmniMultiViewFusionV5 checkpoint on true-GT H36M test subjects.

The v81 checkpoint was trained with the WebBridge mixed loader (``n_views=14``).
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate v81 checkpoint on true-GT H36M test subjects S9/S11",
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="outputs/ablations/v81_true_gt_h36m_medium_a800.pth",
        help="Path to v81 .pth checkpoint",
    )
    parser.add_argument(
        "--config_json",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=13,
        help="Stride for test clips. Use 1 for dense eval, 13 to match prior v81 test reporting.",
    )
    parser.add_argument(
        "--out_json",
        type=str,
        default="outputs/eval_v81_true_gt_h36m_test.json",
