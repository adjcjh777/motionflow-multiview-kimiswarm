...
# (DC-PSC, a.k.a. Dual-Camera Pose Calibration) on the corrected (non-circular)
# H36M true-GT v2 protocol (S1,5,6,7,8 train -> S9/S11 val).
#
...
#   bash scripts/run_v57_true_gt_v2_medium_a800.sh
#
#   # Run on a specific free project GPU
#   CUDA_VISIBLE_DEVICES=7 bash scripts/run_v57_true_gt_v2_medium_a800.sh
#
#   # Typical detached launch
#   nohup bash scripts/run_v57_true_gt_v2_medium_a800.sh \
#       > outputs/ablations/v57_true_gt_v2_medium_a800_nohup.log 2>&1 &
