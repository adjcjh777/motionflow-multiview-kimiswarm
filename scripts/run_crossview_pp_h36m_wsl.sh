...
# Train on subject 1 actions 02-09, validate on subject 5 action 02.
TRAIN=""
for a in 02 03 04 05 06 07 08 09; do
...
python -u experiments/train_ray_attention_temporal_crossview_residual_principal_point_mpiinf3dhp.py \
  --train $TRAIN \
  --val data/webbridge/h36m_meters/s_05_acts_02_multiview_m.npz \
