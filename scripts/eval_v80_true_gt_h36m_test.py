"""Evaluate a v80 OmniMultiViewFusionV5 checkpoint on true-GT H36M test subjects.

The v80 checkpoint was trained with the WebBridge mixed loader (``n_views=14``).
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate v80 checkpoint on true-GT H36M test subjects S9/S11",
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="outputs/ablations/v80_true_gt_regularization_a800.pth",
        help="Path to v80 .pth checkpoint",
    )
    parser.add_argument(
        "--config_json",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=13,
        help="Stride for test clips. Use 1 for dense eval, 13 to match prior v80 test reporting.",
    )
    parser.add_argument(
        "--out_json",
        type=str,
        default="outputs/eval_v80_true_gt_h36m_test.json",
