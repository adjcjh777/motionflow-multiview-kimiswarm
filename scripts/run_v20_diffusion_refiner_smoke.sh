#!/usr/bin/env bash
# v20 smoke test: diffusion-based pose refiner wired with the diffusion training
# loss on the WebBridge/H36M/MPI mixed smoke split.  Runs in <30 min on RTX 4090.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --epochs 2 --batch_size 8 --train_samples 200 --val_stride 50 \
    ...
    --pa_loss_weight 0.5 --monotonic_loss_weight 0.0 --monotonic_margin 5.0 \
    ...
    --output outputs/omniview_fusion_v20_diffusion_refiner_smoke.pth \
    > outputs/omniview_fusion_v20_diffusion_refiner_smoke.log 2>&1

echo "v20 smoke test finished.  Log: outputs/omniview_fusion_v20_diffusion_refiner_smoke.log"
