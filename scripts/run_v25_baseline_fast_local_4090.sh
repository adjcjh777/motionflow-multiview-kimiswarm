#!/usr/bin/env bash
# v25 baseline fast local 4090 (d=64, n_st_layers=2) for direct comparison with v29a.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v25_baseline_fast_small_local_4090.pth \
    > outputs/omniview_fusion_v25_baseline_fast_small_local_4090.log 2>&1 &
echo $! > outputs/v25_baseline_fast_local_4090_train.pid
wait $!
