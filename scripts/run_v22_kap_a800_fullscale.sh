#!/usr/bin/env bash
# v22 KAP full-scale A800 run: v18 + v21 + v22 KAP.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v22_kap_a800_fullscale.pth \
    > outputs/omniview_fusion_v22_kap_a800_fullscale.log 2>&1
