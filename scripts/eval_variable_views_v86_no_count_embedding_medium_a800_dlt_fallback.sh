#!/usr/bin/env bash
# Variable-view inference with DLT fallback for v86 no-count-embedding A800
# medium checkpoint. Falls back to direct confidence-weighted DLT whenever
# n_active < n_views_max.
set -euo pipefail
...
OUT_PREFIX="outputs/variable_view_fix/variable_view_v86_no_count_embedding_medium_a800_dlt_fallback"
...
echo "v86 A800 variable-view DLT-fallback eval complete. Results: ${OUT_PREFIX}.{csv,json}"
