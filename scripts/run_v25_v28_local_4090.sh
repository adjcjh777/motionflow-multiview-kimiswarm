#!/usr/bin/env bash
# v25 + v28 physical-space alignment small local 4090 run.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v25_v28_small_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v25_v28_small_local_4090.log}
EPOCHS=${EPOCHS:-20}
