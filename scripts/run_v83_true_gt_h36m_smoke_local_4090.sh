#!/usr/bin/env bash
# Local RTX 4090 smoke for v83: view-conditioned temporal attention on v25 ray tokens.
# Built on the v25 stability recipe (low LR, no view permutation).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v83_true_gt_h36m_smoke.pth \
    > outputs/omniview_fusion_v83_true_gt_h36m_smoke.log 2>&1
