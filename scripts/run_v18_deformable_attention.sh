#!/usr/bin/env bash
# v18 experiment: deformable epipolar-aware cross-view attention on top of v11.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v18_deformable_attention.pth \
    > outputs/omniview_fusion_v18_deformable_attention.log 2>&1
