#!/usr/bin/env bash
# v25 + v18 top-k ST + v27 UDP small local 4090 run.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v25_v18_topk_v27_udp_small_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v25_v18_topk_v27_udp_small_local_4090.log}
EPOCHS=${EPOCHS:-20}
