...
# Ablation 3: v25 true-GT mixed-dataset training (H36M + MPI-INF-3DHP)
# Hypothesis: the true-GT H36M training set is too small for the model capacity.
# Uses the same hyperparameter fixes as ablation 1 but trains on the mixed manifest.
