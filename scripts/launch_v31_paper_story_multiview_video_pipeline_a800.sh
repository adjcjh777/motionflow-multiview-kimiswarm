#!/usr/bin/env bash
# Launch v31 paper-story multi-view video pipeline on A800-D.
# This is the full-capacity run: d=128, batch_size=16, train_samples=4000.
# It combines the v30 hardened hierarchical encoder, the v29 physical-space
# temporal loss with warmup, and the full variable-view curriculum.  TTE is
# intentionally disabled because the TTE module is broken.
set -euo pipefail
...
# v31 paper story: v30 hierarchical + physical loss + variable views, no TTE.
launch_if_free v31_paper_story_multiview_video_pipeline_a800 0 "--use_hierarchical_multiview_v30 --v30_n_part_layers 2 --v30_stochastic_depth_prob 0.1 --use_physical_space_temporal_loss_v29 --v29_floor_loss_weight 0.01 --v29_bone_temporal_weight 0.01 --v29_com_jitter_weight 0.001 --v29_physical_loss_warmup_epochs 2 --output outputs/omniview_fusion_v31_paper_story_multiview_video_pipeline_a800.pth"
