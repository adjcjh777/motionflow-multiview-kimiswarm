#!/usr/bin/env bash
# v13_temporal_fullscale full-scale run (10000 samples / 60 epochs) experiment: temporal consistency (velocity + acceleration) on top of v12.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --temporal_loss_weight 0.03 \
    --temporal_acceleration_weight 0.25 \
    --clip_len 27 \
    --output outputs/omniview_fusion_v13_temporal_fullscale.pth \
    > outputs/omniview_fusion_v13_temporal_fullscale.log 2>&1
