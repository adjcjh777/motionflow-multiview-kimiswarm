#!/usr/bin/env bash
# v13 experiment: temporal consistency (velocity + acceleration) on top of v12.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --clip_len 27 \
    --output outputs/omniview_fusion_v13_temporal.pth \
    > outputs/omniview_fusion_v13_temporal.log 2>&1
