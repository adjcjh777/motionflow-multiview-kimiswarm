#!/usr/bin/env bash
# Split v85 no-fallback variable-view eval into per-k chunks to survive
...
OUT_PREFIX="outputs/variable_view_v85_random_view_dropout_medium_a800"
...
for K in 2 3 4; do
    echo "[$(date -Iseconds)] Starting v85 no-fallback eval for k=${K}"
...
echo "v85 A800 split-k no-fallback eval complete. Results: ${OUT_PREFIX}_k{2,3,4}.{csv,json}"
