#!/usr/bin/env bash
# Local RTX 4090 medium run for v57 Domain-Conditional Physical-Space
# Calibration (DC-PSC) on the NON-CIRCULAR H36M true-GT standard protocol
# (S1,5,6,7,8 train -> S9/S11 val; issue #194).
#
# This script is prepared but NOT executed. Run it manually only when the local
# GPU is free and no other training is in progress.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v57_h36m_true_gt_medium.pth \
    > outputs/omniview_fusion_v57_h36m_true_gt_medium.log 2>&1
