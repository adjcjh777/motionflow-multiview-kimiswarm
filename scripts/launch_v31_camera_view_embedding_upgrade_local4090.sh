#!/usr/bin/env bash
# v31 camera-view-embedding upgrade – smoke test on local RTX 4090.
set -euo pipefail
export PYTHONUNBUFFERED=1
PYTHON=${PYTHON:-python}

$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_v31_camera_view_embedding_upgrade.py \
    --smoke \
    ...
    --use_camera_view_embedding --camera_view_embedding_hidden 64 \
    ...
    --output outputs/omniview_fusion_v31_camera_view_embedding_upgrade_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_camera_view_embedding_upgrade_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_camera_view_embedding_upgrade_smoke_local_4090.pid
wait $!
