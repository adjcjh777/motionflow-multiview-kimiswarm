#!/usr/bin/env bash
# Debug run without v53 to see if NaN originates earlier.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v52_nan_debug.pth \
    > outputs/v52_nan_debug.log 2>&1
echo "v52 debug finished with exit code $?"
