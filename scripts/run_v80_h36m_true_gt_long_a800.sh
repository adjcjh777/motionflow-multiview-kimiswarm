...
# val; issue #194). First learned-model convergence attempt on real H36M
# mocap labels.
#
# Same model/loss configuration as the verified local 2-epoch wiring smoke
# (scripts/run_v80_h36m_true_gt_smoke_local_4090.sh, best val 98.12 mm),
# scaled to 20 epochs on the full ~390k-frame train set.
#
# Sanity anchors: DLT baseline on these labels = S9 29.54 / S11 21.81 mm
# (data/h36m_true_gt/dlt_baseline_h36m.json). The learning goal is to close
# the gap to DLT; val MPJPE in the tens of mm, monotonically falling, no NaN.
#
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v80_h36m_true_gt_long.pth \
    > outputs/omniview_fusion_v80_h36m_true_gt_long.log 2>&1
