#!/usr/bin/env bash
# Evaluate the AIST++-only medium fast-v2 checkpoint on the true-GT H36M S9/S11 test set (A800-D).
#
...
#
#   # Use a different GPU
#   CUDA_VISIBLE_DEVICES=7 bash scripts/eval_aistpp_only_on_h36m_test_a800.sh
set -euo pipefail
