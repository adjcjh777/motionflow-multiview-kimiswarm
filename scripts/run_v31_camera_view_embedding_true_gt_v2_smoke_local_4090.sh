#!/usr/bin/env bash
# v31 camera-view embedding smoke run on local RTX 4090 using the corrected
# (non-circular) H36M true-GT v2 protocol.
#
# Usage
# -----
#   bash scripts/run_v31_camera_view_embedding_true_gt_v2_smoke_local_4090.sh
#
#   # Run on a specific GPU
#   CUDA_VISIBLE_DEVICES=1 bash scripts/run_v31_camera_view_embedding_true_gt_v2_smoke_local_4090.sh
set -euo pipefail
...
mkdir -p outputs/smoke_v31_true_gt_v2
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_camera_view_embedding_v31 \
    --camera_view_embedding_hidden 32 \
    --num_workers 0 \
    --d 128 \
    --residual_hidden 256 \
    --n_st_layers 3 \
    ...
    --output outputs/smoke_v31_true_gt_v2/v31_camera_view_embedding_true_gt_v2_smoke_local_4090.pth \
    > outputs/smoke_v31_true_gt_v2/v31_camera_view_embedding_true_gt_v2_smoke_local_4090.log 2>&1
