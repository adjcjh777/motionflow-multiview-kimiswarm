...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v57_domain_conditional_psc_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v57_domain_conditional_psc_smoke_local_4090.log 2>&1
