#!/usr/bin/env bash
# Local RTX 4090 smoke for v86: random whole-view dropout WITHOUT the
# active-view-count embedding.  Mirrors the v85 smoke except for the count
# embedding flag.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v86_no_count_embedding_true_gt_h36m_smoke_local_4090.pth \
    > outputs/v86_no_count_embedding_true_gt_h36m_smoke_local_4090.log 2>&1
