#!/usr/bin/env bash
# v18-only small A800 baseline for clean comparison against v22/v23/v25 variants.
# Enables v18 deformable cross-view attention plus the standard v5/v11/v18 base stack,
# but does NOT add KAP (v22), neural BA (v21), or geometry fusion (v25).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v18_baseline_small_a800.pth \
    > outputs/omniview_fusion_v18_baseline_small_a800.log 2>&1
