#!/usr/bin/env bash
# v25 + v27 UDP warm-start small local 4090 run.
set -euo pipefail
...
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v25_v27_udp_small_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v25_v27_udp_small_local_4090.log}
EPOCHS=${EPOCHS:-20}
