...
OUT_PREFIX="outputs/variable_view_fix/variable_view_v86_no_count_embedding_true_gt_v2_medium_a800_dlt_fallback"
...
echo "v86 true-GT v2 A800 variable-view DLT-fallback eval complete. Results: ${OUT_PREFIX}.{csv,json}"
