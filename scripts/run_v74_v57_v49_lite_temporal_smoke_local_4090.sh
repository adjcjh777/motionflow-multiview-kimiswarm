#!/usr/bin/env bash
# Local RTX 4090 smoke test for v57 DC-PSC + v49-Lite causal temporal aggregation.
#
# v74: add lightweight temporal smoothing on top of the strongest single module
# (v57) to see if it improves temporal consistency without hurting MPJPE.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v74_v57_v49_lite_temporal_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v74_v57_v49_lite_temporal_smoke_local_4090.log 2>&1
