"""Evaluate a v85 random view dropout checkpoint on true-GT H36M test subjects.

The v85 checkpoint uses the same OmniMultiViewFusionV5 architecture as v81.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate v85 random view dropout checkpoint on true-GT H36M test subjects S9/S11",
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="outputs/ablations/v85_random_view_dropout_medium_a800.pth",
        help="Path to v85 .pth checkpoint",
    )
    parser.add_argument(
        "--config_json",
        type=str,
    ...
    parser.add_argument("--val_stride", type=int, default=13)
    parser.add_argument(
        "--out_json",
        type=str,
        default="outputs/eval_v85_random_view_dropout_medium_a800_h36m_test.json",
