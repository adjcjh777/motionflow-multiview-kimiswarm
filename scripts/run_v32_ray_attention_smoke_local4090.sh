#!/usr/bin/env bash
# v32 smoke test: ray-conditioned cross-view attention on local RTX 4090.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v32_ray_attention_smoke_local_4090.pth \
    > outputs/omniview_fusion_v32_ray_attention_smoke_local_4090.log 2>&1 &
echo $! > outputs/v32_ray_attention_smoke_local_4090.pid
wait $!
