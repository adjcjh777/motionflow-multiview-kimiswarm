#!/usr/bin/env bash
# Local RTX 4090 smoke test for v56 Adaptive Physical Loss Weighting (APL)
# on top of the v45/v46/v50/v51/v52/v53 stack.
#
# Identity-at-init: a v53 checkpoint loaded with v56 enabled should give the
# same val_MPJPE (within ~0.1 mm).
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v56_apl_hidden 32 \
    --v56_apl_identity_init \
    --v56_apl_loss_weight 0.01 \
    --v56_apl_warmup_epochs 0 \
    --num_workers 0 \
    --d 64 \
    --residual_hidden 128 \
    --n_st_layers 2 \
    ...
    --output outputs/omniview_fusion_v56_apl_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v56_apl_smoke_local_4090.log 2>&1
