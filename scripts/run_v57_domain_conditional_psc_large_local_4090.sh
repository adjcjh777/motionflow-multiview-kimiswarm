#!/usr/bin/env bash
# Local RTX 4090 large smoke for v57 Domain-Conditional Physical-Space
# Calibration (DC-PSC) on top of the v45/v46/v50/v51/v52 stack.
#
# 500 samples, 5 epochs. Run only when the GPU is free.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v57_domain_conditional_psc_large_local_4090.pth \
    >> outputs/omniview_fusion_v57_domain_conditional_psc_large_local_4090.log 2>&1
