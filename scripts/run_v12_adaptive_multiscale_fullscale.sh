#!/usr/bin/env bash
# v12_adaptive_multiscale_fullscale full-scale run (10000 samples / 60 epochs) experiment: adaptive scale-selective multi-scale fusion on top of v10/v11.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v12_adaptive_multiscale_fullscale.pth \
    > outputs/omniview_fusion_v12_adaptive_multiscale_fullscale.log 2>&1
