#!/usr/bin/env bash
# v29 Hierarchical Multi-View + Physical/Temporal Loss smoke run on local RTX 4090
# using the corrected (non-circular) H36M true-GT v2 protocol.
#
# This is a LIGHTWEIGHT smoke config intended to quickly verify that the v29
# training pipeline completes without hanging.  It uses a smaller model and far
# fewer samples than the medium run so that one RTX 4090 finishes in minutes.
set -euo pipefail
...
mkdir -p outputs/smoke_v29_true_gt_v2
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/smoke_v29_true_gt_v2/v29_hierarchical_true_gt_v2_smoke_local_4090_fixed.pth \
    > outputs/smoke_v29_true_gt_v2/v29_hierarchical_true_gt_v2_smoke_local_4090_fixed.log 2>&1
