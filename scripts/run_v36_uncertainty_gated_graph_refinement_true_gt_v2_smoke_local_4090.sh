#!/usr/bin/env bash
# v36 Uncertainty-Gated Iterative Graph Refinement smoke run on local RTX 4090
# using the corrected (non-circular) H36M true-GT v2 protocol.
#
# Usage
# -----
#   bash scripts/run_v36_uncertainty_gated_graph_refinement_true_gt_v2_smoke_local_4090.sh
#
#   # Run on a specific GPU
#   CUDA_VISIBLE_DEVICES=1 bash scripts/run_v36_uncertainty_gated_graph_refinement_true_gt_v2_smoke_local_4090.sh
set -euo pipefail
...
mkdir -p outputs/smoke_v36_true_gt_v2
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v35_tvjgn_n_heads 4 \
    --use_uncertainty_gated_iterative_graph_refinement_v36 \
    --v36_ugigr_n_layers 1 \
    --v36_ugigr_n_iters 2 \
    --v36_ugigr_n_heads 4 \
    ...
    --output outputs/smoke_v36_true_gt_v2/v36_uncertainty_gated_graph_refinement_true_gt_v2_smoke_local_4090.pth \
    > outputs/smoke_v36_true_gt_v2/v36_uncertainty_gated_graph_refinement_true_gt_v2_smoke_local_4090.log 2>&1
