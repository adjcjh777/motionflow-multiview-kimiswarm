#!/usr/bin/env bash
# v31 smoke test: v30 hierarchical encoder without variable-view training.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v31_hierarchical_no_variable_views_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_hierarchical_no_variable_views_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_hierarchical_no_variable_views_smoke_local_4090.pid
wait $!
