#!/usr/bin/env bash
# Local RTX 4090 smoke test for v79 Canonical-View Geometric Refinement
# (ARGUS-inspired) on top of the v57 DC-PSC stack.
#
# This is a medium smoke (50 samples/seq, 3 epochs).  Do not start when another
# local training run is using the GPU.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_v79_canonical_view_refinement \
    --v79_cvr_hidden 64 \
    --v79_cvr_n_layers 2 \
    --v79_cvr_identity_init \
    --v79_cvr_residual_gate_init -6.0 \
    --num_workers 0 \
    --d 64 \
    --residual_hidden 128 \
    --n_st_layers 2 \
    ...
    --output outputs/omniview_fusion_v79_canonical_view_refinement_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v79_canonical_view_refinement_smoke_local_4090.log 2>&1
