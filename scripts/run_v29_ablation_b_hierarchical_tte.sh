#!/usr/bin/env bash
# v29b: hierarchical encoder + TTE (no physical temporal loss).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v29b_hierarchical_tte_small_local_4090.pth \
    > outputs/omniview_fusion_v29b_hierarchical_tte_small_local_4090.log 2>&1 &
echo $! > outputs/v29b_local_4090_train.pid
wait $!
