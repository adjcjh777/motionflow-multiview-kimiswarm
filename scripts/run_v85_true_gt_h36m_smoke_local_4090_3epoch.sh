#!/usr/bin/env bash
# Local RTX 4090 3-epoch smoke for v85: random whole-view dropout with active-view-count embedding.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v85_true_gt_h36m_smoke_local_4090_3epoch.pth \
    > outputs/v85_true_gt_h36m_smoke_local_4090_3epoch.log 2>&1
