#!/usr/bin/env bash
# Local RTX 4090 smoke test for v55 Outlier-Robust Reliability (OR2)
# on top of the v45/v46/v50/v51/v52/v53/v54 stack.
#
# v55 inserts an identity-at-init outlier-robust reliability module between
# v45 adaptive geometry fusion and v52 UWT.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_v55_outlier_robust_reliability \
    --v55_orr_hidden 64 \
    --v55_orr_n_layers 2 \
    --v55_orr_weight_type per_view_joint \
    --v55_orr_use_geometry_bias \
    --v55_orr_use_feature_bias \
    --v55_orr_identity_init \
    --v55_orr_min_weight 0.05 \
    --v55_orr_cauchy_gamma_init 1.0 \
    --v55_orr_residual_gate_init -6.0 \
    --v55_orr_loss_weight 0.01 \
    --v55_orr_warmup_epochs 0 \
    ...
    --output outputs/omniview_fusion_v55_orr_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v55_orr_smoke_local_4090.log 2>&1
