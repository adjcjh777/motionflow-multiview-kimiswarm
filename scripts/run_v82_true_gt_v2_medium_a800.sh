#!/usr/bin/env bash
# A800-D medium run for v82 multi-scale temporal-pose-attention on the corrected
# (non-circular) H36M true-GT v2 protocol (S1,5,6,7,8 train -> S9/S11 val).
#
# This is the v82 ablation: v25 multi-view geometry fusion + multi-scale
# per-joint temporal pose attention over triangulated 3-D poses.
#
# Usage
# -----
#   # Default: run on GPU 6 (project only uses GPUs 6/7 on A800)
#   bash scripts/run_v82_true_gt_v2_medium_a800.sh
#
#   # Run on a specific free GPU
#   CUDA_VISIBLE_DEVICES=7 bash scripts/run_v82_true_gt_v2_medium_a800.sh
#
#   # Typical detached launch
#   nohup bash scripts/run_v82_true_gt_v2_medium_a800.sh \
#       > outputs/ablations/v82_true_gt_v2_medium_a800_nohup.log 2>&1 &
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v82_true_gt_v2_medium_a800.pth \
    > outputs/ablations/v82_true_gt_v2_medium_a800.log 2>&1
