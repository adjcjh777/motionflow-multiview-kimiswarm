#!/usr/bin/env bash
# Local RTX 4090 medium run v3 for v53 PSC.
# Keeps reduced PSC loss weight and warmup; tests the clamped canonical bone
# lengths fix that prevents unbounded exponential growth in physical-space calibration.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v53_psc_medium_v3_local_4090.pth \
    >> outputs/omniview_fusion_v53_psc_medium_v3_local_4090.log 2>&1
