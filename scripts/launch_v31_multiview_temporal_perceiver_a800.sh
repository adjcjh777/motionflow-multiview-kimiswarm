#!/usr/bin/env bash
# Launch v31 (v30 hardened hierarchical + v19 temporal perceiver + physical loss warmup) on A800-D.
# This script is a reference/template; do not launch on A800-D unless the smoke test on RTX 4090 passes.
set -euo pipefail
...
# v31a: hardened hierarchical + temporal perceiver + physical loss warmup.
launch_if_free v31a_multiview_temporal_perceiver_a800 0 "--output outputs/omniview_fusion_v31a_multiview_temporal_perceiver_a800.pth"
