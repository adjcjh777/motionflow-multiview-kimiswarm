#!/usr/bin/env bash
# A800 launch script for v80 full-medium training on AIST++.
#
...
#   bash scripts/run_v80_aistpp_full_medium_a800.sh
#
#   # Run on a different GPU
#   CUDA_VISIBLE_DEVICES=4 bash scripts/run_v80_aistpp_full_medium_a800.sh
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v80_aistpp_full_medium_a800.pth \
    > outputs/ablations/v80_aistpp_full_medium_a800.log 2>&1
