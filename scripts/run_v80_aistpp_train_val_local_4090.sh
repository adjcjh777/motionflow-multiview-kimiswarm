#!/usr/bin/env bash
# Local RTX 4090 v80 (view-reliability weighting) training on AIST++ full train/val split.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v80_aistpp_train_val.pth \
    > outputs/omniview_fusion_v80_aistpp_train_val.log 2>&1
