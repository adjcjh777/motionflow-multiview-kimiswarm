#!/usr/bin/env bash
# v17 cross-view transformer: small-scale 4090 smoke run.
# Uses the fast WebBridge smoke split so a first val_MPJPE is produced
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --epochs 5 --batch_size 8 --train_samples 500 --val_stride 10 \
    ...
    --use_cross_view_transformer_v17 \
    ...
    --output outputs/v17_crossview_transformer_smoke_4090.pth \
    > outputs/v17_crossview_transformer_smoke_4090.log 2>&1
