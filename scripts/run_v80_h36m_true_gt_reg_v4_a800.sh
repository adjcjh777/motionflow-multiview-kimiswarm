#!/usr/bin/env bash
# A800-D REGULARIZED v80 run (recipe v4) on the non-circular H36M true-GT standard
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v80_h36m_true_gt_reg_v4.pth \
    > outputs/omniview_fusion_v80_h36m_true_gt_reg_v4.log 2>&1
