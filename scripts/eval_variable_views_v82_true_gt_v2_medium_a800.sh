#!/usr/bin/env bash
# Variable-view inference benchmark for v82 true-GT v2 A800 checkpoint.
set -euo pipefail
...
CKPT="outputs/ablations/v82_true_gt_v2_medium_a800.pth"
CONFIG="outputs/ablations/v82_true_gt_v2_medium_a800.config.json"
MANIFEST="tmp/h36m_true_gt_v2_val_manifest.txt"
OUT_PREFIX="outputs/variable_view_v82_true_gt_v2_medium_a800"
...
echo "v82 true-GT v2 A800 variable-view eval complete. Results: ${OUT_PREFIX}.{csv,json}"
