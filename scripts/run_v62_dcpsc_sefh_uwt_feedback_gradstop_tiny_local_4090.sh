...
#
# v62: stop v57 PSC auxiliary-loss gradients from reaching the v52/v60 base,
# so the PSC loss only updates v57 parameters.  This lets us re-enable the
# v57 loss_weight without repeating the v61/v61b divergence.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v62_dcpsc_sefh_uwt_feedback_gradstop_tiny_local_4090.pth \
    >> outputs/omniview_fusion_v62_dcpsc_sefh_uwt_feedback_gradstop_tiny_local_4090.log 2>&1
