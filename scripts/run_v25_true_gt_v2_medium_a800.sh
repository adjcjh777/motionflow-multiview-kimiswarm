#!/usr/bin/env bash
# A800-D medium run for v25 multi-view geometry fusion on the corrected
# (non-circular) H36M true-GT v2 protocol (S1,5,6,7,8 train -> S9/S11 val).
#
# This is the full-scale A800 counterpart to
# scripts/run_v25_h36m_true_gt_medium_local_4090.sh, using the v25 stability
# recipe and the v2 manifest (configs/splits/h36m_true_gt_v2_standard.yaml).
#
# Usage
# -----
#   # Default: run on GPU 7 (project only uses GPUs 6/7 on A800)
#   bash scripts/run_v25_true_gt_v2_medium_a800.sh
#
#   # Run on a specific free GPU
#   CUDA_VISIBLE_DEVICES=6 bash scripts/run_v25_true_gt_v2_medium_a800.sh
#
#   # Typical detached launch
#   nohup bash scripts/run_v25_true_gt_v2_medium_a800.sh \
#       > outputs/ablations/v25_true_gt_v2_medium_a800_nohup.log 2>&1 &
...
# GPU discipline: project only uses GPUs 6/7 on A800. Default to 7, allow override.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v25_true_gt_v2_medium_a800.pth \
