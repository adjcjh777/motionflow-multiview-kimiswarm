#!/usr/bin/env bash
# v10_aleatoric_outlier_fullscale full-scale run (10000 samples / 60 epochs) full experiment: aleatoric reprojection + outlier-view augmentation + reproj warmup.
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v10_aleatoric_outlier_fullscale.pth \
    > outputs/omniview_fusion_v10_aleatoric_outlier_fullscale.log 2>&1
