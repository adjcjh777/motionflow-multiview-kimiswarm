...
# on the non-circular H36M true-GT standard protocol.
#
# This is the v52-only ablation (no v57, no v80).  Uses a tiny schedule so it
# finishes in < 30 min on the RTX 4090 for wiring/flag validation.
#
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v52_true_gt_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v52_true_gt_h36m_smoke_local_4090.log 2>&1
