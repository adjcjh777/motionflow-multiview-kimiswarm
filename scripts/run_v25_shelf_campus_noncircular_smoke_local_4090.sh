...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_variable_view_training --variable_view_min_views 2 --variable_view_max_views 5 \
    ...
    --output outputs/omniview_fusion_v25_shelf_campus_noncircular_smoke.pth \
    > outputs/omniview_fusion_v25_shelf_campus_noncircular_smoke.log 2>&1
