#!/usr/bin/env bash
# Local RTX 4090 smoke for v86 unified sparse-view / cross-domain baseline.
#
# Runs a short 2-epoch training on the H36M true-GT standard protocol to verify
# that the combined v85 + v86 count-conditioning + v86 sparse-view-head stack
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v86_sparse_cross_domain_true_gt_h36m_smoke_local_4090.pth \
    > outputs/v86_sparse_cross_domain_true_gt_h36m_smoke_local_4090.log 2>&1
