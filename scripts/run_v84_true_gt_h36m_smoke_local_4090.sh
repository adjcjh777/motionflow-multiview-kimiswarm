#!/usr/bin/env bash
# Local RTX 4090 smoke for v84: uncertainty-weighted view dropout on v25 ray tokens.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v84_d 128 \
    --v84_hidden 64 \
    --v84_weight_type per_view \
    --v84_use_reprojection \
    --v84_use_epipolar \
    ...
    --output outputs/v84_true_gt_h36m_smoke_local_4090.pth \
    > outputs/v84_true_gt_h36m_smoke_local_4090.log 2>&1
