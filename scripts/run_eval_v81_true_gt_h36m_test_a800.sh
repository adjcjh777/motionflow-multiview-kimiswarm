#!/usr/bin/env bash
# Run v81 temporal-pose-attention true-GT H36M test evaluation on A800-D.
#
# Uses the best checkpoint from the v81 medium run:
#   outputs/ablations/v81_true_gt_h36m_medium_a800.pth
#
...
echo "Evaluating v81 true-GT checkpoint on H36M test S9/S11 (GPU ${CUDA_VISIBLE_DEVICES})"
...
echo "Done. Results: outputs/eval_v81_true_gt_h36m_test_a800.json"
