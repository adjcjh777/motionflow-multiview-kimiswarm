#!/usr/bin/env bash
# v31 smoke test on local RTX 4090:
# v30 hardened hierarchical encoder + v19 temporal perceiver + v29 physical loss warmup.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v31_multiview_temporal_perceiver_smoke_local4090.pth \
    > outputs/omniview_fusion_v31_multiview_temporal_perceiver_smoke_local4090.log 2>&1 &
echo $! > outputs/v31_multiview_temporal_perceiver_smoke_local4090.pid
wait $!
