#!/usr/bin/env bash
# Local RTX 4090 medium run v2 for v53 PSC.
# Reduces PSC loss weight and enables warmup after the first attempt diverged.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v53_psc_medium_v2_local_4090.pth \
    >> outputs/omniview_fusion_v53_psc_medium_v2_local_4090.log 2>&1
