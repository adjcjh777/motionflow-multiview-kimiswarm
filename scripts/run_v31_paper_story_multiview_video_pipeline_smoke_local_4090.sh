#!/usr/bin/env bash
# v31 paper-story multi-view video pipeline smoke test on local RTX 4090.
# Tiny config for fast feedback; mirrors the A800 full run at reduced capacity.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v31_paper_story_multiview_video_pipeline_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_paper_story_multiview_video_pipeline_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_paper_story_multiview_video_pipeline_smoke_local_4090.pid
wait $!
