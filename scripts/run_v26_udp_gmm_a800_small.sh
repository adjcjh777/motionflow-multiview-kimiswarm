#!/usr/bin/env bash
# v26 + UDP-GMM small: temporal geometry fusion + GMM uncertainty-aware depth proposals.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v26_udp_gmm_small.pth}
LOG=${LOG:-outputs/omniview_fusion_v26_udp_gmm_small.log}
