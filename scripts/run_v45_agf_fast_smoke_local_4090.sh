#!/usr/bin/env bash
# Fast local RTX 4090 smoke test for v45-AGF.
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --reproj_warmup_epochs 0 \
    --aleatoric_reproj_loss_weight 0.1 \
    --outlier_view_prob 0.0 \
    --outlier_view_max_views 0 \
    --use_hierarchical_multiview_v30 \
    --v30_n_part_layers 2 \
    --v30_stochastic_depth_prob 0.1 \
    --output outputs/v45_agf_fast_smoke_local_4090.pth \
    >> outputs/v45_agf_fast_smoke_local_4090.log 2>&1
