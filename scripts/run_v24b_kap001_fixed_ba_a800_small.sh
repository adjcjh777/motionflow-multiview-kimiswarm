#!/usr/bin/env bash
# v24b small: v18 + fixed v21 neural BA + v22 KAP (kap_loss_weight=0.001).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v24b_kap001_fixed_ba_small.pth \
    > outputs/omniview_fusion_v24b_kap001_fixed_ba_small.log 2>&1
