#!/usr/bin/env bash
# v10 small-fast smoke-scale experiment for quick validation.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --epochs 10 --batch_size 16 --train_samples 2000 --val_stride 10 \
    ...
    --output outputs/omniview_fusion_v10_small_fast.pth \
    > outputs/omniview_fusion_v10_small_fast.log 2>&1
