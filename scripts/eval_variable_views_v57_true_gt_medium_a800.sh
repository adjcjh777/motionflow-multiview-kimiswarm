#!/usr/bin/env bash
# Variable-view inference benchmark for v57 A800 re-run checkpoint.
set -euo pipefail
cd /mnt/nvme0n1p1/zhangzy/motionflow-multiview-kimiswarm-iter20

CKPT="outputs/ablations/v57_true_gt_medium_a800.pth"
CONFIG="outputs/ablations/v57_true_gt_medium_a800.config.json"
MANIFEST="tmp/h36m_true_gt_val_manifest.txt"
OUT_PREFIX="outputs/variable_view_v57_true_gt_medium_a800"
...
echo "v57 A800 variable-view eval complete. Results: ${OUT_PREFIX}.{csv,json}"