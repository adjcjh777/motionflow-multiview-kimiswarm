#!/usr/bin/env bash
# Local RTX 4090 smoke: v25 true-GT WITH random per-view dropout.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --view_dropout_rate 0.5 \
    --outlier_view_prob 0.0 \
    --output outputs/v25_true_gt_h36m_smoke_viewdropout_local_4090.pth \
    > outputs/v25_true_gt_h36m_smoke_viewdropout_local_4090.log 2>&1
