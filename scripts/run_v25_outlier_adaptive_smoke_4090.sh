#!/usr/bin/env bash
# v25 + adaptive outlier-view detector smoke on local RTX 4090.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v25_outlier_adaptive_smoke_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v25_outlier_adaptive_smoke_4090.log}
