#!/usr/bin/env bash
# Fast v26 smoke: reaches first val_MPJPE in ~10 minutes on A800.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v26_temporal_geometry_fusion_smoke_fast.pth \
    > outputs/omniview_fusion_v26_temporal_geometry_fusion_smoke_fast.log 2>&1
