#!/usr/bin/env bash
# Local RTX 4090 run for v25 + physical loss + domain weights.
# This tests whether the best additions from v42-v43 can improve the strong v25 baseline.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_skeleton_physical_loss_v40 \
    --v40_bone_weight 0.05 \
    --v40_joint_limit_weight 0.01 \
    --v40_symmetry_weight 0.02 \
    --v40_floor_weight 0.02 \
    --domain_loss_weights 1.0,1.5 \
    --output outputs/v25_physical_domain_local_4090_full.pth \
    >> outputs/v25_physical_domain_local_4090_full.log 2>&1
