#!/usr/bin/env bash
# A800 tmux launcher for v25 + v27 UDP full-scale run.
set -euo pipefail

SESSION="v25_v27_udp_gpu4"
LOG="outputs/omniview_fusion_v25_v27_udp_a800.log"
...
tmux send-keys -t "$SESSION" "CUDA_VISIBLE_DEVICES=4 python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \\
    ...
    --output outputs/omniview_fusion_v25_v27_udp_a800.pth > $LOG 2>&1" C-m
