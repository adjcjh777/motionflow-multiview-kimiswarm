#!/usr/bin/env bash
# A800-D medium run for the v46 Sparse-View Generalization (SVG) baseline on
# the NON-CIRCULAR H36M true-GT standard protocol (S1,5,6,7,8 train -> S9/S11
# val).
#
# This script realises the recipe in configs/ablations/v46_true_gt_h36m_a800.yaml.
#
# Usage
# -----
#   # Default: run on GPU 4
#   bash scripts/run_v46_true_gt_h36m_a800.sh
#
#   # Run on a specific free GPU
#   CUDA_VISIBLE_DEVICES=6 bash scripts/run_v46_true_gt_h36m_a800.sh
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v46_true_gt_h36m_a800.pth \
    > outputs/ablations/v46_true_gt_h36m_a800.log 2>&1
