#!/usr/bin/env bash
# v41 Weighted Domain Loss smoke run on local RTX 4090 using the corrected
# (non-circular) H36M true-GT v2 protocol.
#
# Usage
# -----
#   bash scripts/run_v41_weighted_domain_loss_true_gt_v2_smoke_local_4090.sh
#
#   # Run on a specific GPU
#   CUDA_VISIBLE_DEVICES=1 bash scripts/run_v41_weighted_domain_loss_true_gt_v2_smoke_local_4090.sh
set -euo pipefail
...
mkdir -p outputs/smoke_v41_true_gt_v2
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/smoke_v41_true_gt_v2/v41_weighted_domain_loss_true_gt_v2_smoke_local_4090.pth \
    > outputs/smoke_v41_true_gt_v2/v41_weighted_domain_loss_true_gt_v2_smoke_local_4090.log 2>&1
