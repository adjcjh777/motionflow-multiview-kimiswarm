#!/usr/bin/env bash
# v31 ablation: v30 hierarchical encoder with increased dropout / stochastic depth.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v30_dropout 0.3 --v30_stochastic_depth_prob 0.2 \
    --use_physical_space_temporal_loss_v29 --v29_floor_loss_weight 0.01 \
    --v29_bone_temporal_weight 0.01 --v29_com_jitter_weight 0.001 \
    --v29_physical_loss_warmup_epochs 1 \
    --output outputs/omniview_fusion_v31_hierarchical_more_dropout_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_hierarchical_more_dropout_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_hierarchical_more_dropout_smoke_local_4090.pid
wait $!
