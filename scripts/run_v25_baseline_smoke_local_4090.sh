#!/usr/bin/env bash
# v25 geometry-fusion baseline smoke test on the local RTX 4090.
# Mirrors scripts/run_v27_udp_smoke_local_4090.sh but without the v27 UDP head.
# Use this as the control to isolate the effect of the uncertainty-aware depth
# proposals.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PY=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v25_baseline_smoke_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v25_baseline_smoke_local_4090.log}
