#!/usr/bin/env bash
# A800-D medium run for v86 unified sparse-view / cross-domain baseline.
#
# Stacks v85 random whole-view dropout + active-view-count embedding, v86
# stronger MLP-based count conditioning, and the v86 separate sparse-view head
# for k<4.  Targets the corrected H36M true-GT standard protocol
# (S1,5,6,7,8 train -> S9/S11 val).
#
# Usage
# -----
#   # Default: GPU 6 (project only uses GPUs 6/7; override if busy)
#   bash scripts/run_v86_sparse_cross_domain_medium_a800.sh
#
#   # Run on a specific free GPU
#   CUDA_VISIBLE_DEVICES=7 bash scripts/run_v86_sparse_cross_domain_medium_a800.sh
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v86_sparse_cross_domain_medium_a800.pth \
    > outputs/ablations/v86_sparse_cross_domain_medium_a800.log 2>&1
