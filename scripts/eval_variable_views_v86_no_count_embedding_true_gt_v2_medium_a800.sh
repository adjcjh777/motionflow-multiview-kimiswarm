#!/usr/bin/env bash
# Variable-view inference benchmark for v86 no-count-embedding A800 checkpoint on
# the true-GT v2 validation set.
set -euo pipefail
...
OUT_PREFIX="outputs/variable_view_v86_no_count_embedding_true_gt_v2_medium_a800"
...
echo "v86 true-GT v2 A800 variable-view eval complete. Results: ${OUT_PREFIX}.{csv,json}"
