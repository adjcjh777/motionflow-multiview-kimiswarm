#!/usr/bin/env bash
# Local RTX 4090 medium smoke for v54 Physical-Space Calibration v2 (PSC-v2)
# on top of the v45/v46/v50/v51/v52/v53 stack.
#
# 500 clips / 5 epochs to compare against the v53 PSC baseline.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v54_psc_v2_medium_local_4090.pth \
    >> outputs/omniview_fusion_v54_psc_v2_medium_local_4090.log 2>&1
