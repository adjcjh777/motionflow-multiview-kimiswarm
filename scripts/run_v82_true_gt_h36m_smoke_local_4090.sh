#!/usr/bin/env bash
# Local RTX 4090 smoke for v82 on NON-CIRCULAR H36M true-GT standard protocol.
# v25 geometry fusion + multi-scale per-joint temporal pose attention.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v82_true_gt_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v82_true_gt_h36m_smoke_local_4090.log 2>&1
