#!/usr/bin/env bash
# v31 hierarchical_deeper_spatial smoke test on local RTX 4090.
#
# Goal: deepen the v30 spatial hierarchy (part-scale attention) and verify
# that stochastic depth + dropout + physical-loss warmup keep it stable on
# a tiny subset before committing A800 cycles.
#
# Hard constraints honoured:
#   - TTE is broken and is NOT enabled.
#   - Physical loss has a 2-epoch warmup.
#   - Local RTX 4090, small config only.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_hierarchical_multiview_v30 --v30_n_part_layers 3 --v30_stochastic_depth_prob 0.15 --v30_dropout 0.2 \
    ...
    --output outputs/omniview_fusion_v31_hierarchical_deeper_spatial_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_hierarchical_deeper_spatial_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_hierarchical_deeper_spatial_smoke_local_4090.pid
wait $!
