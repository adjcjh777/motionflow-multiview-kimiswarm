#!/usr/bin/env bash
# Launch v24 small on A800 GPU via tmux.
# Usage: bash scripts/launch_v24_a800_tmux.sh [GPU]
set -euo pipefail

cd /mnt/nvme0n1/zhangzy/motionflow-multiview-kimiswarm-iter20
GPU=${1:-0}
NAME="v24_kap_fixed_ba_gpu${GPU}"
OUTPUT="outputs/omniview_fusion_v24_kap_fixed_ba_gpu${GPU}.pth"
LOG="outputs/omniview_fusion_v24_kap_fixed_ba_gpu${GPU}.log"
