#!/usr/bin/env bash
# Local RTX 4090 smoke test for v60 SEFH -> UWT feedback loop.
# Builds on the v45/v46/v50/v51/v52 stack and closes the loop by feeding the
# v50 reliability estimate into v52 as a weights prior.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v60_sefh_uwt_feedback_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v60_sefh_uwt_feedback_smoke_local_4090.log 2>&1
