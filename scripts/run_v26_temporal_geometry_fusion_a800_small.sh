#!/usr/bin/env bash
# v26 small: v18 deformable cross-view attention + v26 temporal geometry fusion.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v26_temporal_geometry_fusion_small.pth \
    > outputs/omniview_fusion_v26_temporal_geometry_fusion_small.log 2>&1
