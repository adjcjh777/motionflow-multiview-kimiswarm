#!/usr/bin/env bash
# v31 hierarchical_wider_d128 smoke test on local RTX 4090 (d=128, small batch).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --num_workers 0 --d 128 --residual_hidden 256 --n_st_layers 2 \
    ...
    --use_hierarchical_multiview_v30 --v30_n_part_layers 2 --v30_dropout 0.15 --v30_stochastic_depth_prob 0.15 \
    --use_physical_space_temporal_loss_v29 --v29_floor_loss_weight 0.01 --v29_bone_temporal_weight 0.01 \
    --v29_com_jitter_weight 0.001 --v29_physical_loss_warmup_epochs 1 --weight_decay 1e-4 \
    --output outputs/omniview_fusion_v31_hierarchical_wider_d128_local4090.pth \
    > outputs/omniview_fusion_v31_hierarchical_wider_d128_local4090.log 2>&1 &
echo $! > outputs/v31_hierarchical_wider_d128_local4090.pid
wait $!
