#!/usr/bin/env bash
# v29e fast local 4090 run: hierarchical + physical loss, no TTE.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_hierarchical_multiview_v29 --use_physical_space_temporal_loss_v29 \
    --v29_floor_loss_weight 0.01 --v29_bone_temporal_weight 0.01 --v29_com_jitter_weight 0.001 \
    --num_workers 0 --d 64 --residual_hidden 128 --n_st_layers 1 \
    --graph_num_layers 1 --n_joint_layers 1 --n_heads 4 \
    --clip_len 9 --epochs 20 --batch_size 8 --train_samples 100 --val_stride 10 \
    ...
    --outlier_view_prob 0.3 --outlier_view_max_views 1 --outlier_view_offset_std 10.0 --outlier_view_noise_std 15.0 \
    --output outputs/omniview_fusion_v29e_hierarchical_physical_fast_small_local_4090.pth \
    > outputs/omniview_fusion_v29e_hierarchical_physical_fast_small_local_4090.log 2>&1 &
echo $! > outputs/v29e_fast_local_4090_train.pid
wait $!
