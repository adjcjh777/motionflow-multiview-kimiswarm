#!/usr/bin/env bash
# Variable-view inference benchmark for v85 random-view-dropout A800 checkpoint
# on the true-GT v2 validation set.
set -euo pipefail
...
OUT_PREFIX="outputs/variable_view_v85_random_view_dropout_true_gt_v2_medium_a800"
...
echo "v85 true-GT v2 A800 variable-view eval complete. Results: ${OUT_PREFIX}.{csv,json}"
