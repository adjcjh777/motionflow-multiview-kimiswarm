#!/usr/bin/env bash
# Tiny v53 debug run to confirm NaN fix.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v29_physical_loss_warmup_epochs 0 \
    --output outputs/v53_nan_debug.pth \
    > outputs/v53_nan_debug.log 2>&1
echo "v53 NaN debug finished with exit code $?"
