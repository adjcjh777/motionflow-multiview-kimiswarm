#!/usr/bin/env bash
# v31 geometry-biased hierarchical encoder smoke test on local RTX 4090.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_hierarchical_multiview_v31 --v30_n_part_layers 2 --v30_dropout 0.1 --v30_stochastic_depth_prob 0.1 \
    ...
    --output outputs/omniview_fusion_v31_geometry_attention_refinement_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_geometry_attention_refinement_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_geometry_attention_refinement_smoke_local_4090.pid
wait $!
