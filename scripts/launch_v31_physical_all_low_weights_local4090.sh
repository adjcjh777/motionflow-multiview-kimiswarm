#!/usr/bin/env bash
# v31 smoke test: v30 hierarchical encoder with all physical-space temporal loss weights lowered.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v29_floor_loss_weight 0.001 \
    --v29_bone_temporal_weight 0.001 \
    --v29_com_jitter_weight 0.0001 \
    --v29_physical_loss_warmup_epochs 2 \
    --output outputs/omniview_fusion_v31_physical_all_low_weights_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_physical_all_low_weights_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_physical_all_low_weights_smoke_local_4090.pid
wait $!
