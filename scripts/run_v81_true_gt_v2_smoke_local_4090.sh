#!/usr/bin/env bash
# Local RTX 4090 smoke for v81 on NON-CIRCULAR H36M true-GT v2 standard protocol.
# v25 geometry fusion + lightweight per-joint temporal pose attention.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v81_true_gt_v2_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v81_true_gt_v2_h36m_smoke_local_4090.log 2>&1
