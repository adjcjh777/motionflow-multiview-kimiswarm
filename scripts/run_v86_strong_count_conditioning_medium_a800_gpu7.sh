...
#   bash scripts/run_v86_strong_count_conditioning_medium_a800_gpu7.sh
#
#   # Run on a specific free GPU (must be 6 or 7 per project policy)
#   CUDA_VISIBLE_DEVICES=6 bash scripts/run_v86_strong_count_conditioning_medium_a800_gpu7.sh
