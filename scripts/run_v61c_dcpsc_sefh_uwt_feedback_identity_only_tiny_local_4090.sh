...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v61c_dcpsc_sefh_uwt_feedback_identity_only_tiny_local_4090.pth \
    >> outputs/omniview_fusion_v61c_dcpsc_sefh_uwt_feedback_identity_only_tiny_local_4090.log 2>&1
