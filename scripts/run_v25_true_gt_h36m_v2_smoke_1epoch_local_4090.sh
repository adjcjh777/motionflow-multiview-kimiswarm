#!/usr/bin/env bash
# Local RTX 4090 smoke for v25 baseline on H36M true-GT v2 (standard protocol).
# One-epoch quick smoke to sanity-check the v2 split.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v25_true_gt_v2_smoke_1epoch_local_4090.pth \
    > outputs/v25_true_gt_v2_smoke_1epoch_local_4090.log 2>&1
