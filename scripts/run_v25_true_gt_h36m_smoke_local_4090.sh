#!/usr/bin/env bash
# Local RTX 4090 smoke for v25 baseline on NON-CIRCULAR H36M true-GT standard
# protocol. Same tiny schedule as v81 for direct comparison.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v25_true_gt_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v25_true_gt_h36m_smoke_local_4090.log 2>&1
