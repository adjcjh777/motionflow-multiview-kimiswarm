...
# Ablation 1: v25 H36M true-GT baseline fix
# Hypothesis: divergence is purely hyperparameteric.
# Key changes: train_samples 4096, early stopping, weight decay, lower LR,
# longer warmup, milder outlier augmentation, reduced v25 geometry loss weight.
