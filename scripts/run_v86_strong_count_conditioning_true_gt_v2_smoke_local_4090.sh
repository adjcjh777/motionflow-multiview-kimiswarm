#!/usr/bin/env bash
# Local RTX 4090 smoke for v86: stronger explicit view-count token / MLP
# conditioning on top of the v85 random whole-view dropout recipe.
# Uses the corrected H36M true-GT v2 protocol.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v86_strong_count_conditioning_true_gt_v2_h36m_smoke_local_4090.pth \
    > outputs/v86_strong_count_conditioning_true_gt_v2_h36m_smoke_local_4090.log 2>&1
