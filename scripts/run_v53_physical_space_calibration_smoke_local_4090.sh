#!/usr/bin/env bash
# Local RTX 4090 smoke test for v53 Physical-Space Calibration (PSC)
# on top of the v45/v46/v50/v51/v52 stack.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v53_psc_smoke_local_4090.pth \
    >> outputs/omniview_fusion_v53_psc_smoke_local_4090.log 2>&1
