#!/usr/bin/env bash
# v31 smoke test: v30 hierarchical encoder + v29 physical loss + v31 self-collision penalty.
# Runs locally on RTX 4090 for fast feedback only; not for A800-D.
# NOTE: the --use_physical_collision_penalty_v31 flag and its hyperparameters
# require wiring the new module in motionflow_mv/losses/physical_collision_penalty_v31.py
# into motionflow_mv/fusion/omniview_fusion_v5.py and the training script before this
# run is actually runnable.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_physical_collision_penalty_v31 --v31_collision_loss_weight 0.001 \
    --v31_collision_margin 0.05 --v31_collision_bone_radius 0.07 --v31_collision_warmup_epochs 1 \
    --output outputs/omniview_fusion_v31_physical_collision_penalty_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_physical_collision_penalty_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_physical_collision_penalty_smoke_local_4090.pid
wait $!
