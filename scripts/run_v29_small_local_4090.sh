#!/usr/bin/env bash
# v29 small local 4090 run (compares against v25 baseline).
set -euo pipefail
...
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v29_self_evolving_hierarchical_small_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v29_self_evolving_hierarchical_small_local_4090.log}
EPOCHS=${EPOCHS:-20}
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --epochs $EPOCHS --batch_size 8 --train_samples $TRAIN_SAMPLES --val_stride 10 \
    ...
    > $LOG 2>&1 &
TRAIN_PID=$!
echo $TRAIN_PID > outputs/v29_local_4090_train.pid
wait $TRAIN_PID
