#!/usr/bin/env bash
# v19 experiment: temporal Perceiver refinement on top of v11 baseline.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v19_temporal_perceiver.pth \
    > outputs/omniview_fusion_v19_temporal_perceiver.log 2>&1
