"""Evaluate a v57 OmniMultiViewFusionV5 checkpoint on true-GT H36M test subjects.

The v57 checkpoint was trained with the WebBridge mixed loader (``n_views=14``).
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=13,
        help="Stride for test clips. Use 1 for dense eval, 13 to match prior v57 test reporting.",
    )
    parser.add_argument(
        "--out_json",
        type=str,
        default="outputs/eval_v57_true_gt_h36m_test.json",
