#!/usr/bin/env bash
# v30 smoke test on local RTX 4090 (tiny config, fast feedback).
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v30_smoke_local_4090.pth \
    > outputs/omniview_fusion_v30_smoke_local_4090.log 2>&1 &
echo $! > outputs/v30_smoke_local_4090.pid
wait $!
