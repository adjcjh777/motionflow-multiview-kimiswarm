#!/usr/bin/env bash
# Medium v47 temporal local RTX 4090 run (5 epochs, 500 samples, d=64).
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v47_temporal_svg_medium_local_4090.pth \
    >> outputs/v47_temporal_svg_medium_local_4090.log 2>&1
