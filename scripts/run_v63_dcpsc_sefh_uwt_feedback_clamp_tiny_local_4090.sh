...
#
# v63: clamp the v57 physical-space correction to [-0.5, 0.5] m and stop
# gradients so the PSC loss only updates v57 parameters.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v63_dcpsc_sefh_uwt_feedback_clamp_tiny_local_4090.pth \
    >> outputs/omniview_fusion_v63_dcpsc_sefh_uwt_feedback_clamp_tiny_local_4090.log 2>&1
