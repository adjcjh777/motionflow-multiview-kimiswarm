#!/usr/bin/env bash
# Local RTX 4090 smoke test for v46 on MPI-INF-3DHP only (non-circular labels).
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v46_mpi_only_noncircular_smoke.pth \
    >> outputs/omniview_fusion_v46_mpi_only_noncircular_smoke.log 2>&1
