#!/usr/bin/env bash
# v17 experiment: cross-view transformer view aggregation on top of v11.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v17_crossview_transformer.pth \
    > outputs/omniview_fusion_v17_crossview_transformer.log 2>&1
