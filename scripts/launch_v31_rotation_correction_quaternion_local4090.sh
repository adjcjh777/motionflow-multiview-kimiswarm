#!/usr/bin/env bash
# v31 smoke test: quaternion rotation correction on local RTX 4090.
# This is a fast smoke run only; do not use for full-scale A800 training.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_quaternion_rotation_correction \
    ...
    --v29_com_jitter_weight 0.001 --v29_physical_loss_warmup_epochs 2 \
    --output outputs/omniview_fusion_v31_rotation_correction_quaternion_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_rotation_correction_quaternion_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_rotation_correction_quaternion_smoke_local_4090.pid
wait $!
