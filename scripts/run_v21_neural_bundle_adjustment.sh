#!/usr/bin/env bash
# v21 experiment: neural bundle-adjustment pose/camera refiner on top of v17.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v21_neural_bundle_adjustment.pth \
    > outputs/omniview_fusion_v21_neural_bundle_adjustment.log 2>&1
