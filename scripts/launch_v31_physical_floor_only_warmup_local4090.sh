#!/usr/bin/env bash
# v31 smoke test on local RTX 4090: v30 hierarchical + floor-only physical loss with warmup.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v29_floor_loss_weight 0.01 --v29_bone_temporal_weight 0.0 --v29_com_jitter_weight 0.0 \
    --v29_physical_loss_warmup_epochs 3 \
    --output outputs/omniview_fusion_v31_physical_floor_only_warmup_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_physical_floor_only_warmup_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_physical_floor_only_warmup_local_4090.pid
wait $!
