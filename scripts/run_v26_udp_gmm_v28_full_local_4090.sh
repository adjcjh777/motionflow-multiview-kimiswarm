#!/usr/bin/env bash
# v26 + UDP-GMM + v28 physical-space alignment full-scale local 4090 run with early stopping.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v26_udp_gmm_v28_full_local_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v26_udp_gmm_v28_full_local_4090.log}
