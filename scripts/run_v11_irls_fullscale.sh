#!/usr/bin/env bash
# v11_irls_fullscale full-scale run (10000 samples / 60 epochs) experiment: IRLS Cauchy robust reweighting on top of v10.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v11_irls_fullscale.pth \
    > outputs/omniview_fusion_v11_irls_fullscale.log 2>&1
