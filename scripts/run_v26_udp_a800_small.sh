#!/usr/bin/env bash
# v26 + UDP small: temporal geometry fusion + uncertainty-aware depth proposals.
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v26_udp_small.pth}
LOG=${LOG:-outputs/omniview_fusion_v26_udp_small.log}
