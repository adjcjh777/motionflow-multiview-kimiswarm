#!/usr/bin/env bash
# Fast local RTX 4090 smoke test for v51 Domain-Agnostic Ensemble (DAE).
# Uses fewer samples/epochs to quickly validate code changes.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v51_dae_min_weight 0.0 \
    --v51_dae_loss_weight 0.0 \
    --num_workers 0 \
    --d 64 \
    --residual_hidden 128 \
    --n_st_layers 2 \
    ...
    --output outputs/v51_dae_smoke_fast_local_4090.pth \
    >> outputs/v51_dae_smoke_fast_local_4090.log 2>&1
