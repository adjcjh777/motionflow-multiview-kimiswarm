#!/usr/bin/env bash
# v31 smoke test: v30 hierarchical encoder + explicit outlier-view detector
# with a more adaptive (lower z, higher beta) threshold.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v25_use_outlier_view_detector --v25_outlier_z_thresh 2.0 --v25_outlier_soft_beta 2.0 \
    ...
    --v29_com_jitter_weight 0.001 --v29_physical_loss_warmup_epochs 1 \
    --output outputs/omniview_fusion_v31_outlier_view_adaptive_threshold_smoke_local_4090.pth \
    > outputs/omniview_fusion_v31_outlier_view_adaptive_threshold_smoke_local_4090.log 2>&1 &
echo $! > outputs/v31_outlier_view_adaptive_threshold_smoke_local_4090.pid
wait $!
