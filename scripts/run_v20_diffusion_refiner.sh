#!/usr/bin/env bash
# v20 experiment: diffusion-based pose refiner as a drop-in replacement for the
# deterministic residual MLP in OmniMultiViewFusionV5.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v20_diffusion_refiner.pth \
    > outputs/omniview_fusion_v20_diffusion_refiner.log 2>&1
