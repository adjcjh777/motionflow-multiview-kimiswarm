...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_test_time_self_evolution_v29 --use_physical_space_temporal_loss_v29 \
    ...
    --output outputs/omniview_fusion_v29d_tte_physical_only_small_local_4090.pth \
    > outputs/omniview_fusion_v29d_tte_physical_only_small_local_4090.log 2>&1 &
echo $! > outputs/v29d_local_4090_train.pid
wait $!
