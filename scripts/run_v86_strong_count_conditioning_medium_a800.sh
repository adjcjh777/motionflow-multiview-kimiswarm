#!/usr/bin/env bash
# A800-D medium run for v86: stronger explicit view-count token / MLP
# conditioning on top of v85 random whole-view dropout.
#
# Target protocol: H36M true-GT standard (S1,5,6,7,8 train -> S9/S11 val).
#
# Usage
# -----
#   # Default: GPU 6 (override with CUDA_VISIBLE_DEVICES if needed)
#   bash scripts/run_v86_strong_count_conditioning_medium_a800.sh
#
#   # Run on GPU 7 (must be free per project policy)
#   CUDA_VISIBLE_DEVICES=7 bash scripts/run_v86_strong_count_conditioning_medium_a800.sh
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v86_strong_count_conditioning_medium_a800.pth \
    > outputs/ablations/v86_strong_count_conditioning_medium_a800.log 2>&1
