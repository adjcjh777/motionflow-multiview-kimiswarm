#!/usr/bin/env bash
# Variable-view inference benchmark for v80 H36M true-GT medium checkpoint.
...
MANIFEST="scripts/eval_variable_views_h36m_true_gt/h36m_true_gt_val_manifest.txt"
OUT_PREFIX="tmp/variable_view_v80_h36m_true_gt_medium"
...
echo "v80 variable-view eval complete. Results: ${OUT_PREFIX}.{csv,json}"
