#!/usr/bin/env bash
# A800 launch script for v57 full-medium training on AIST++.
#
# Uses configs/splits/aistpp_train_val_test_mixed.yaml (9 views, 17 joints).
# Full-medium: 12 epochs, 2048 samples/epoch, batch size 16.
# Targets A800 GPU 6 by default; override with CUDA_VISIBLE_DEVICES.
#
# Usage
# -----
#   # Default: run on GPU 6
#   bash scripts/run_v57_aistpp_full_medium_a800.sh
#
#   # Run on a different GPU
#   CUDA_VISIBLE_DEVICES=4 bash scripts/run_v57_aistpp_full_medium_a800.sh
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v45_adaptive_weight_hidden 32 --v45_adaptive_weight_n_layers 1 \
    --use_v46_sparse_view_generalization \
    --v46_svg_view_dropout_prob 0.3 --v46_svg_min_views 2 --v46_svg_use_curriculum \
    --use_v50_self_evolution_feedback_head \
    --v50_sefh_hidden 64 --v50_sefh_num_layers 2 --v50_sefh_dropout 0.1 \
    --v50_sefh_identity_init_gate --v50_sefh_loss_weight 0.0 --v50_sefh_aleatoric_weight 0.0 \
    --use_v51_cross_domain_sparse_view_reliability \
    --v51_cdsvr_hidden 64 --v51_cdsvr_num_heads 4 --v51_cdsvr_dropout 0.1 \
    --v51_cdsvr_offset_min 0.05 --v51_cdsvr_use_domain_label --v51_cdsvr_identity_init_gate \
    --v51_cdsvr_loss_weight 0.0 --v51_cdsvr_uncertainty_temperature 1.0 \
    --use_v52_uncertainty_weighted_triangulation \
    --v52_uwt_hidden 64 --v52_uwt_n_layers 2 --v52_uwt_weight_type per_view_joint \
    --v52_uwt_use_geometry_bias --v52_uwt_use_feature_bias --v52_uwt_identity_init \
    --v52_uwt_min_weight 0.05 --v52_uwt_loss_weight 0.01 --v52_uwt_damping 1e-4 \
    ...
    --v57_dcpsc_loss_weight 0.1 --v57_dcpsc_floor_weight 0.01 --v57_dcpsc_bone_weight 0.1 \
    --v57_dcpsc_reproj_weight 0.1 --v57_dcpsc_warmup_epochs 1 --v57_dcpsc_min_visible_views 2 \
    --num_workers 4 \
    --d 128 --residual_hidden 256 --n_st_layers 3 \
    --graph_num_layers 1 --n_joint_layers 1 --n_heads 4 \
    --clip_len 13 \
    --epochs 12 --batch_size 16 --train_samples 2048 --val_stride 20 \
    ...
    --v30_n_part_layers 2 --v30_stochastic_depth_prob 0.1 \
    ...
    --output outputs/ablations/v57_aistpp_full_medium_a800.pth \
    > outputs/ablations/v57_aistpp_full_medium_a800.log 2>&1
