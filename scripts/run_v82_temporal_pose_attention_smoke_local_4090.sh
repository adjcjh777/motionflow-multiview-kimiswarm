#!/usr/bin/env bash
# Local RTX 4090 smoke for v82: v25 + multi-scale per-joint temporal pose attention.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v82_temporal_pose_attention_smoke.pth \
    > outputs/omniview_fusion_v82_temporal_pose_attention_smoke.log 2>&1
