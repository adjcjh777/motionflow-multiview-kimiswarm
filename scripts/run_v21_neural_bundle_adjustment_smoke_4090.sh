#!/usr/bin/env bash
# v21 neural bundle-adjustment smoke run on local RTX 4090.
# Uses the safety-fixed NeuralBundleAdjustment (structure-first ordering,
# compact rotation descriptor, residual-gated camera updates).
set -euo pipefail

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}
PYTHON=${PYTHON:-/d/anaconda3/python}
OUTPUT=${OUTPUT:-outputs/omniview_fusion_v21_neural_bundle_adjustment_smoke_4090.pth}
LOG=${LOG:-outputs/omniview_fusion_v21_neural_bundle_adjustment_smoke_4090.log}
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --epochs 2 --batch_size 8 --train_samples 200 --val_stride 10 \
