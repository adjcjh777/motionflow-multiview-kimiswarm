#!/usr/bin/env bash
# v31 per-joint gated skeleton-graph residual refiner smoke test on local RTX 4090.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --use_context_visibility true --use_skeleton_residual_v31 --use_rotation_correction true \
