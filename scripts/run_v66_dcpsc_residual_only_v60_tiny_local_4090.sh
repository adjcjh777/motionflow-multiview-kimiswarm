#!/usr/bin/env bash
# Local RTX 4090 smoke test for v57 residual-only + v60 SEFH→UWT feedback.
#
# v66: keep only the v57 gated residual correction (no floor/bone heads) to
# isolate whether the floor/bone terms are responsible for the v57+v60
# divergence seen in v61/v61b/v61c.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --no_v57_dcpsc_use_floor \
    --no_v57_dcpsc_use_bone_scale \
    ...
    --output outputs/omniview_fusion_v66_dcpsc_residual_only_v60_tiny_local_4090.pth \
    >> outputs/omniview_fusion_v66_dcpsc_residual_only_v60_tiny_local_4090.log 2>&1
