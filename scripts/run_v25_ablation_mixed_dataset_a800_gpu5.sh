#!/usr/bin/env bash
# A800 GPU 5 launch script for v25 ablation 3: mixed-dataset training
# (H36M true-GT standard protocol + AIST++ canonical data).
#
# GPU 5 is the preferred free GPU for this run. Launch with:
#   nohup bash scripts/run_v25_ablation_mixed_dataset_a800_gpu5.sh &
...
# GPU discipline: pin to GPU 5 explicitly.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v25_true_gt_mixed_dataset_a800_gpu5.pth \
    > outputs/ablations/v25_true_gt_mixed_dataset_a800_gpu5.log 2>&1
