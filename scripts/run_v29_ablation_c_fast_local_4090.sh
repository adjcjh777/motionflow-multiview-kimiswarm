#!/usr/bin/env bash
# v29c fast local 4090 run for quick ablation comparison.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v29c_fast_small_local_4090.pth \
    > outputs/omniview_fusion_v29c_fast_small_local_4090.log 2>&1 &
echo $! > outputs/v29c_fast_local_4090_train.pid
wait $!
