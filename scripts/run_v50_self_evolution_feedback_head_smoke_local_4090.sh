#!/usr/bin/env bash
# Local RTX 4090 smoke test for v50 Self-Evolution Feedback Head (SEFH).
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v50_self_evolution_feedback_head_smoke_local_4090.pth \
    >> outputs/v50_self_evolution_feedback_head_smoke_local_4090.log 2>&1
