#!/usr/bin/env bash
# v15 experiment: kinematic-chain auxiliary losses on top of v13.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --joint_limit_max_flexion 160.0 \
    --temporal_bone_weight 0.01 \
    --output outputs/omniview_fusion_v15_kinematic_chain_fullscale.pth \
    > outputs/omniview_fusion_v15_kinematic_chain_fullscale.log 2>&1
