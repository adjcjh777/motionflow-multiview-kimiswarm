#!/usr/bin/env bash
# v31 smoke test on local RTX 4090: v30 hierarchical encoder + COM-only
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v31_physical_com_only_warmup_local4090.pth \
    > outputs/omniview_fusion_v31_physical_com_only_warmup_local4090.log 2>&1 &
echo $! > outputs/v31_physical_com_only_warmup_local4090.pid
wait $!
