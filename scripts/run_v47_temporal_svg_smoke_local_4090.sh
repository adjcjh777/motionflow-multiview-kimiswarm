#!/usr/bin/env bash
# Local RTX 4090 smoke test for v47 temporal aggregation on top of v46 sparse-view generalization.
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v47_temporal_svg_smoke_local_4090.pth \
    >> outputs/v47_temporal_svg_smoke_local_4090.log 2>&1
