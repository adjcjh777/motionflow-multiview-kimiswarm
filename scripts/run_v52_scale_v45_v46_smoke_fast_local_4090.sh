#!/usr/bin/env bash
# Fast local RTX 4090 smoke for v52: scaled v45-AGF + v46-SVG.
# Tests the stronger regularization config before the A800 full run.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/v52_scale_v45_v46_smoke_fast_local_4090.pth \
    >> outputs/v52_scale_v45_v46_smoke_fast_local_4090.log 2>&1
