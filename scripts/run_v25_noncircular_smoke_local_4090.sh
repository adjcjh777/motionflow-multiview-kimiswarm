#!/usr/bin/env bash
# Local RTX 4090 non-circular smoke for v25 geometry fusion.
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v25_noncircular_smoke.pth \
    > outputs/omniview_fusion_v25_noncircular_smoke.log 2>&1
