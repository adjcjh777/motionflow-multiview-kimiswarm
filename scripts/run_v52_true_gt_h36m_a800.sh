#!/usr/bin/env bash
# A800-D medium run for v52 Uncertainty-Weighted Triangulation (UWT) on the
...
#   bash scripts/run_v52_true_gt_h36m_a800.sh
#
#   # Run on a specific free GPU
#   CUDA_VISIBLE_DEVICES=6 bash scripts/run_v52_true_gt_h36m_a800.sh
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/ablations/v52_true_gt_h36m_a800.pth \
    > outputs/ablations/v52_true_gt_h36m_a800.log 2>&1
