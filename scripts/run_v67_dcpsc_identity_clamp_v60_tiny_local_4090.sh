#!/usr/bin/env bash
# Local RTX 4090 smoke test for v57 identity-clamp + v60 SEFH→UWT feedback.
#
# v67: keep v57 physically clamped to a small residual and disable the PSC
# auxiliary loss.  This tests whether v57 can learn a small pose correction
# from the main MSE alone without the PSC loss dominating.
#
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --v57_dcpsc_floor_weight 0.0 \
    --v57_dcpsc_bone_weight 0.0 \
    --v57_dcpsc_reproj_weight 0.0 \
    --v57_dcpsc_warmup_epochs 0 \
    --v57_dcpsc_min_visible_views 2 \
    --v57_dcpsc_stop_grad_to_base \
    ...
    --output outputs/omniview_fusion_v67_dcpsc_identity_clamp_v60_tiny_local_4090.pth \
    >> outputs/omniview_fusion_v67_dcpsc_identity_clamp_v60_tiny_local_4090.log 2>&1
