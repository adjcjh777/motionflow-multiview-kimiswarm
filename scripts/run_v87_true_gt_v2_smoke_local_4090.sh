#!/usr/bin/env bash
# Local RTX 4090 v2 smoke for v87: sparse-view residual head on true-GT v2.
#
# Usage
# -----
#   bash scripts/run_v87_true_gt_v2_smoke_local_4090.sh
#
#   # Run on a specific GPU
#   CUDA_VISIBLE_DEVICES=1 bash scripts/run_v87_true_gt_v2_smoke_local_4090.sh
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v87_true_gt_v2_h36m_smoke_local_4090.pth \
    > outputs/omniview_fusion_v87_true_gt_v2_h36m_smoke_local_4090.log 2>&1
