#!/usr/bin/env bash
# Local RTX 4090 medium smoke for v60 SEFH -> UWT feedback loop.
set -euo pipefail
...
python -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --output outputs/omniview_fusion_v60_sefh_uwt_feedback_medium_local_4090.pth \
    >> outputs/omniview_fusion_v60_sefh_uwt_feedback_medium_local_4090.log 2>&1
