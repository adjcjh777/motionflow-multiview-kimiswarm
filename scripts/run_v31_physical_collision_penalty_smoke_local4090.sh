#!/usr/bin/env bash
# v31 physical collision penalty smoke test on local RTX 4090.
set -euo pipefail
...
$PYTHON -u experiments/train_omniview_fusion_v5_webbridge_multi.py \
    ...
    --clip_len 9 --epochs 3 --batch_size 4 --train_samples 200 --val_stride 1 \
    ...
    --use_physical_collision_penalty_v31 --v31_collision_loss_weight 0.001 --v31_collision_margin 0.05 --v31_collision_warmup_epochs 2 \
