#!/usr/bin/env bash
# Variable-view inference with DLT fallback for v85 A800 medium checkpoint.
# Falls back to direct confidence-weighted DLT whenever n_active < n_views_max.
set -euo pipefail
...
CKPT="outputs/ablations/v85_random_view_dropout_medium_a800.pth"
CONFIG="outputs/ablations/v85_random_view_dropout_medium_a800.config.json"
MANIFEST="tmp/h36m_true_gt_val_manifest.txt"
OUT_PREFIX="outputs/variable_view_fix/variable_view_v85_random_view_dropout_medium_a800_dlt_fallback"
...
echo "v85 A800 variable-view DLT-fallback eval complete. Results: ${OUT_PREFIX}.{csv,json}"
