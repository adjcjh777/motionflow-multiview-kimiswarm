...
This bundle captures the working-tree changes that accumulated after commit `89d794b`:
- Updates to project status, handoff, paper draft, and leaderboard docs.
- The MPI real-detected-2D generation pipeline.
- v25 true-GT ablation configs and runners (baseline fix, geometry regularization, mixed dataset).
- SOTA baseline runner scripts (VoxelPose, MVPose) for H36M true-GT.
- Supporting variable-views eval scripts and split validators for the v57/v80 medium runs.
- Extra planning/checklist docs (48-hour plan, citation verification, submission checklist, paper results table).
...
```text
docs+scripts: H36M true-GT handoff updates, MPI detected-2D pipeline, v25 ablations, and SOTA runners

- Update AGENTS.md, README.md, docs/cvpr2027_status.md,
  docs/handoff_qwen3.8max.md, docs/roadmap_qwen3.8max.md,
  docs/paper_draft_icra_cvpr_2027.md, docs/results_true_gt_h36m.md,
  docs/results_mpi_detected_dlt.md, and scripts/sota_baselines/README.md
  with the latest true-GT protocol status and leaderboard numbers.
...
- Update scripts/generate_mpi_detected_2d_from_avi.py for the MPI
  real detected 2D pipeline.
- Add v25 true-GT ablation configs and runners:
...
- Add variable-views eval and queue scripts for the ongoing medium runs:
...
- Add MPI-INF-3DHP detected-2D smoke split and supporting docs:
  configs/splits/mpi_inf_3dhp_detected_2d_smoke.yaml,
  docs/3dpw_audit.md, docs/a800_missing_data_check.md,
  docs/ablation_schedule.md, docs/48h_plan_2026-08-12.md,
  ...
  docs/next_turn_for_qwen3.8max.md, docs/open_blockers.md,
  docs/paper_results_table.md, docs/project_status_onepager.md,
  docs/qwen3.8max_24h_plan.md, docs/session_summary_2026-08-11.md,
  docs/sparse_view_eval_protocol.md, docs/v25_ablation_plan.md,
  docs/v25_v80_failure_analysis.md, docs/v80_checkpoint_validation.md.
...
- docs/commit_bundle_2026-08-11.md, docs/commit_bundle_2026-08-11_v2.md,
  docs/commit_bundle_2026-08-12.md, docs/git_status_summary.md
...
- Update scripts/generate_mpi_detected_2d_from_avi.py for the MPI
  real detected 2D pipeline.
- Add v25 true-GT ablation configs and runner:
  configs/ablations/v25_true_gt_baseline_fix.yaml,
  configs/ablations/v25_true_gt_geometry_regularization.yaml,
  configs/ablations/v25_true_gt_mixed_dataset.yaml,
  scripts/run_v25_ablation_true_gt_baseline.sh,
...
| `docs/commit_bundle_2026-08-12.md` | This proposed bundle; do not commit. |
