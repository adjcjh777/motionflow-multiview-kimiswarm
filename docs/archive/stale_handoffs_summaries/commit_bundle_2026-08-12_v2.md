# Commit Bundle — 2026-08-12 v2

> Generated: 2026-08-12T06:00:51Z
> Branch: `main`
...
This is the **v2 / final** staging bundle for the v57 H36M true-GT medium run, the v25 true-GT ablation suite, and the surrounding CVPR 2027 documentation and infrastructure updates. It supersedes `docs/commit_bundle_2026-08-12.md` and captures every new/modified doc, config, script, and experiment helper that should enter the repository, while continuing to exclude transient artifacts and large binaries.
...
- docs/commit_bundle_2026-08-11.md, docs/commit_bundle_2026-08-11_v2.md,
  ...
  docs/git_status_summary.md (transient bundle/status drafts)
```
...
| `docs/commit_bundle_2026-08-12_v2.md` | This proposed bundle; do not commit. |
