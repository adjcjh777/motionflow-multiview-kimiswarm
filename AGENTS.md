...
| v57 DC-PSC smoke | v45/v46/v50/v51/v52 + domain-conditional physical-space calibration (FiLM on floor/bone/residual, per-domain gate) | Local tiny smoke done; epoch-2 val_MPJPE 102.38 mm (baseline v52 78.68 mm; tiny smoke, may overfit due to extra ~42k domain-conditional params); medium smoke (50 samples/3 epochs) running after v53 medium v3 process freed RTX 4090; A800 full run queued; fallback v58 SD-PSC implemented; see issue #186 |
