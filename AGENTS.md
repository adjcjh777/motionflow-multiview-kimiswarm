...
| v53 PSC smoke | v45/v46/v50/v51/v52 + physical-space calibration (floor + bone + gated residual) | **Fixed NaN root cause** (`sqrt(weights).clamp` -> `clamp().sqrt()`); A800 tiny smoke best   mm; local tiny smoke best 78.76 mm; local RTX 4090 medium run epoch-1 val_MPJPE **48.24 mm** (v52 medium best 60.09 mm); see issue #183 |
