...
| v33 hierarchical multi-scale spatial pyramid | per-scale geometry-biased cross-view attention | merged | Quick smoke 55.59mm vs v31 55.28mm (no regression); combined+HMSP quick smoke 55.75mm; A800 queued |
