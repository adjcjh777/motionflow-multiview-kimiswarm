...
| v42 v36+physical+domain (no v37) | v36 + v40 physical loss + v41 domain weights; tests whether gains require v37 | RTX 4090 | Bug #151 fixed; full local run restarted with no timeout; A800 queue entry added |
| v43 adaptive per-node residual | v42 + scale v36 UGIGR residual by per-node uncertainty gate | RTX 4090 | Smoke passed (tiny, 10 samples): epoch 2 val_MPJPE 100.53 mm (not representative); full run waiting for GPU; A800 queue entry added; issue #152 |
