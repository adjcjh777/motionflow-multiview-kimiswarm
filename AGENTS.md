...
- **Uncommitted changes:** `configs/sota_baselines/run_mvpose_h36m_true_gt_v2.sh`, `docs/paper_draft_icra_cvpr_2027.md`, `experiments/train_omniview_fusion_v5_webbridge_multi.py`, plus new files for v83 smoke and v2 variable-view scripts.
