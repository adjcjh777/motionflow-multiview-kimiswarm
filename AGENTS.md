...
| v57 DC-PSC smoke | v45/v46/v50/v51/v52 + domain-conditional physical-space calibration (FiLM on floor/bone/residual, per-domain gate) | Local medium smoke done; best val_MPJPE **48.64 mm** (Epoch 1 96.03 mm, Epoch 2 76.75 mm, Epoch 3 48.64 mm); A800 full run queued; fallback v58 SD-PSC implemented; see issue #186 |
...
| v57 DC-PSC large | v57 alone (no v60) on 500 samples, 5 epochs | Running on RTX 4090 to scale the 47.66 mm result; see issue #189 |
| v74 v57+v49-Lite temporal | v57 + lightweight causal temporal aggregation | Script ready; will smoke after v57 large frees GPU; see issue #189 |
