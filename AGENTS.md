...
|-----|-------------|--------|
| v26+UDP full | v26 + v27 UDP + early stopping + weight decay | Running; epoch 2 val 44.72mm, epoch 4 val 84.20mm (overfitting, lr lowered for next variants) |
| v26+UDP-GMM full | v26 + v27 UDP-GMM + early stopping + weight decay | Queued (lr 3e-4, wd 5e-5, patience 3) |
