...
| v36 uncertainty-gated iterative graph refinement | v35 TVJGN + per-node uncertainty gating + iterative refinement; self-evolving fusion | merged | Smoke passed (clip_len=3, d=32, 10 samples): val_MPJPE 100.47mm; PR #145 merged; A800 queue includes on-v34-vjgn, on-v35-tvjgn, on-v34-hmsp-geometry-vjgn, and n_iters=1 ablation; full local run launched after stopping v34; issue #146 opened for v37 design |
