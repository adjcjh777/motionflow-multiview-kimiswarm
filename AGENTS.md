...
| v34 view-joint graph network | (view, joint) graph attention over bone/symmetry/cross-view edges | merged | Quick smoke 54.07mm vs v31 55.28mm; full local run stopped to free GPU after epoch 1 val 27.60mm; A800 queued |
...
| v35 temporal view-joint graph network | v34 VJGN + temporal edges across frames | RTX 4090 | Smoke passed (clip_len=3, d=32); full run ready to launch |
